...
_Generated by `python tools/find-cvars.py` - 2221 distinct cvars._
...
- `g_leanplayer_acceleration`
- `g_leanplayer_acceleration_fade`
- `g_leanplayer_acceleration_max`
- `g_leanplayer_damage`
- `g_leanplayer_damage_fade`
- `g_leanplayer_damage_max`
