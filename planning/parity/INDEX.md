...
_Generated 2026-06-22 from 154 units, 1979 features._
...
|---|---|---|---|---|---|---|---|
| logic | 0 | 959 | 439 | 15 | 524 | 37 | 5 |
| values | 0 | 998 | 364 | 229 | 361 | 5 | 22 |
| timing | 0 | 688 | 223 | 895 | 135 | 2 | 36 |
| presentation | 0 | 194 | 400 | 1130 | 220 | 25 | 10 |
| audio | 0 | 110 | 121 | 1644 | 92 | 5 | 7 |
| liveness | 242 | 0 | 0 | 384 | 160 | 0 | 20 |
...
| `bot-ai.population.namemodel` | Bot name/model from bots.txt (prefix/suffix, dedup, model path) | ~ | OK | - | - | - | live | high |
...
| `bot-ai.target.chooseenemy` | Enemy selection (nearest attackable with LOS, sticky tracking) | ~ | OK | OK | - | - | live | high |
...
| `bot-ai.weapon.reload` | Idle weapon reload (havocbot_ai not-attacking branch) | MISS | MISS | MISS | - | - | - | high |
...
| `bot-waypoints.graph.link_cost` | Link travel-cost model (linear + fall-time + water/crouch) | ~ | ~ | - | - | - | live | high |
...
| `cl-announcer.voice.cvars` | cl_announcer (voice pack) + cl_announcer_antispam wiring | ~ | OK | - | ~ | ~ | DEAD | high |
| `cl-announcer.title.gametype` | Gametype-name centerprint title above countdown | MISS | MISS | - | MISS | - | DEAD | high |
| `cl-announcer.title.duel` | Duel title (A vs B) in 1v1 + ROUNDSTOP | MISS | MISS | MISS | MISS | - | DEAD | high |
...
| `cl-centerprint.countdown.count_token` | ^COUNT countdown decrement | ~ | ~ | ~ | OK | - | live | medium |
...
| `cl-centerprint.kill.group` | centerprint_Kill — graceful group fade-out | OK | OK | OK | OK | - | DEAD | high |
| `cl-centerprint.kill.all_remote` | MSG_CENTER_KILL — remote group / all kill from server | MISS | MISS | MISS | MISS | - | DEAD | high |
| `cl-centerprint.title.gametype` | Gametype title line (centerprint_SetTitle + Announcer driver) | ~ | ~ | - | OK | - | DEAD | high |
| `cl-centerprint.title.duel` | Duel title 'left vs right' (centerprint_SetDuelTitle + Announcer_Duel) | ~ | ~ | - | OK | - | DEAD | high |
| `cl-centerprint.feed.engine_builtin` | Raw engine centerprint() builtin → panel (map/trigger/door/item/MOTD text) | MISS | - | - | MISS | ~ | DEAD | high |
| `cl-centerprint.feed.chat_tell` | Server chat 'tell'/private-message centerprint (cmsg/sourcecmsg) | ~ | - | - | MISS | - | DEAD | high |
...
| `cl-crosshair.anim.pickup_pulse` | Item-pickup crosshair pulse (crosshair_pickup) | OK | OK | OK | OK | - | DEAD | high |
...
| `cl-crosshair.ring.vortex_charge` | Vortex / Overkill-Nex charge ring (+ inner chargepool / moving-average ring) | OK | OK | OK | OK | - | DEAD | high |
| `cl-crosshair.ring.reload_ammo` | Reload / ammo (clip) ring (+ Rifle ring art) | OK | OK | OK | OK | - | DEAD | high |
| `cl-crosshair.ring.minelayer_hagar_arc` | Mine Layer / Hagar load / Arc heat rings | OK | OK | OK | OK | - | DEAD | high |
| `cl-crosshair.ring.switch_fade` | Weapon-switch ring fade-out/in (wcross_ring_prev) | OK | OK | OK | OK | - | DEAD | medium |
...
| `cl-csqcmodel.forcemodel.model_skin` | Force player model / skin (cl_forceplayermodels family) | MISS | MISS | - | MISS | - | - | high |
...
| `cl-csqcmodel.effects.jetpack_loop` | Jetpack loop sound (MF_ROCKET) | OK | OK | OK | - | OK | DEAD | high |
...
| `cl-hud.engine.dock` | HUD dock background (hud_dock) | MISS | stub | - | MISS | - | DEAD | high |
...
| `cl-hud.panel.racetimer` | Race timer panel (#8) | OK | ? | ? | OK | - | DEAD | high |
| `cl-hud.panel.vote` | Vote panel (#9) | OK | ~ | OK | OK | - | DEAD | high |
...
| `cl-hud.panel.checkpoints` | Checkpoints panel (#27) | OK | ? | ? | OK | - | DEAD | high |
| `cl-hud.panel.mapvote` | Map-vote panel | OK | ? | ? | OK | - | DEAD | high |
...
| `cl-scoreboard.fade.inout` | Cross-fade in/out | OK | OK | OK | ~ | - | DEAD | high |
...
| `cl-scoreboard.field.packetloss` | Packet-loss (pl) column | stub | MISS | - | stub | - | DEAD | high |
...
| `cl-scoreboard.block.spectators` | Spectator list | ~ | OK | - | ~ | - | DEAD | high |
...
| `cl-scoreboard.block.rankings` | Race/CTS rankings block | ~ | ~ | - | ~ | - | DEAD | high |
| `cl-scoreboard.block.mapstats` | Map stats (monsters / secrets) | ~ | OK | - | OK | - | ~ | high |
| `cl-scoreboard.block.respawn` | Respawn-status line | ~ | OK | OK | ~ | - | DEAD | high |
...
| `cl-shownames.gate.self_spectatee` | Own-tag in chase + spectatee-switch window | ~ | ~ | MISS | MISS | - | DEAD | high |
...
| `cl-shownames.alpha.entcs_getalpha` | entcs_GetAlpha model-alpha factor + ShowNames_Draw mutator hook | ~ | MISS | - | ~ | - | DEAD | high |
...
| `cl-view.chase.classic_thirdperson` | Classic chase_active third-person + spectator camera (chase_back/up/front/overhead; View_SpectatorCamera) | stub | MISS | ~ | stub | - | DEAD | high |
| `cl-view.kick.punch_angle` | Punch-angle recoil kick (view angle, networked + decayed) | OK | OK | OK | OK | - | live | high |
| `cl-view.kick.punch_vector` | Punch-vector recoil kick (view origin) | ~ | MISS | - | MISS | - | DEAD | high |
...
| `cl-viewmodel.casings.brass_eject` | Brass / shell casings (eject, tumble, bounce, fade, bounce sounds) | stub | ~ | stub | stub | MISS | DEAD | high |
...
| `damage-pipeline.radius.splash` | RadiusDamage: core->edge falloff, falloff-scaled knockback, per-axis force shaping, through-floor LOS, warpzone propagation | ~ | OK | - | - | - | live | high |
| `damage-pipeline.fire.burning` | Burning damage-over-time (Fire_AddDamage / Fire_ApplyDamage + fire transfer) | ~ | ~ | ~ | - | - | live | high |
...
| `assault.objective.inactive_sentinel` | Objective inactive-health sentinel (ASSAULT_VALUE_INACTIVE) | OK | ~ | - | - | - | live | high |
...
| `assault.win.attacker_round` | Attackers destroy the core -> win the round (666 team-score sentinel) | OK | OK | ~ | - | - | ~ | high |
| `assault.round.second_round` | Two-round match: swap roles, re-clock round 2 to round 1 destruction time, 5s round delay | stub | MISS | MISS | - | - | DEAD | high |
| `assault.win.defender_timelimit` | Timelimit elapses without core destruction -> defenders win | stub | MISS | MISS | - | - | DEAD | high |
| `assault.spawns.attacker_defender` | info_player_attacker / info_player_defender team spawn points | OK | OK | - | - | - | ~ | high |
| `assault.notify.role_and_destroyed` | Per-spawn attacking/defending centerprint + objective-destroyed broadcast | MISS | OK | - | stub | - | DEAD | high |
| `assault.objective.waypoint_sprite` | Objective waypoint sprites (defend/push/destroy + health bars + radar icon) | MISS | MISS | MISS | MISS | - | - | high |
| `assault.mapobject.assault_wall` | func_assault_wall cosmetic wall toggles with its objective's health | MISS | MISS | MISS | MISS | - | DEAD | high |
| `assault.turret.roundstart_teamswap` | Roundstart turret team-swap + respawn (and as TurretSpawn team seeding) | MISS | - | - | - | - | - | medium |
| `assault.bot.objective_role` | Bot offense/defense role rating the assault destructible objectives | ~ | ~ | ~ | - | - | live | medium |
| `assault.spawns.objective_evalfunc` | Objective-aware spawn-point eval (deprioritize spots near inactive/destroyed objectives) | MISS | MISS | - | - | - | - | high |
| `assault.objective.destructible_heal` | func_assault_destructible regen / event_heal (walls can be healed back up + sprite update) | MISS | MISS | - | MISS | - | - | high |
| `assault.config.warmup_incompatible` | Assault disables warmup + ready-restart-after-countdown (ReadLevelCvars) | MISS | MISS | - | - | - | - | medium |

### `clanarena` (gametype) — 20 features

| id | name | L | V | T | P | A | live | conf |
|---|---|---|---|---|---|---|---|---|
| `clanarena.round.lifecycle` | Round wait/countdown/live/end-delay state machine | ~ | ~ | ~ | - | - | live | high |
| `clanarena.round.checkteams_gate` | Round-start gate (every active team has a live player) | ~ | - | OK | - | - | ~ | high |
| `clanarena.round.resolution` | Round resolution: last team alive wins, banks a round point | ~ | OK | OK | - | - | live | high |
| `clanarena.round.timelimit_stalemate` | Round time limit + stalemate prevention (survivors/health) | MISS | MISS | MISS | - | - | DEAD | high |
...
| `clanarena.scoring.damage2score` | Damage dealt accrues to scoreboard SCORE (g_ca_damage2score) | ~ | ~ | - | - | - | DEAD | high |
| `clanarena.loadout.start_items` | CA start loadout: 200 health / 200 armor / full ammo | ~ | ~ | - | - | - | DEAD | high |
| `clanarena.loadout.weapon_arena` | Spawn with all weapons (g_ca_weaponarena 'most') | MISS | MISS | - | - | - | - | high |
| `clanarena.items.no_pickups` | No item pickups on the map (FilterItem) | MISS | MISS | - | - | - | - | medium |
...
| `clanarena.notify.round_outcome` | Round-win / tied / over notifications + 'You are now alone' | MISS | - | MISS | MISS | MISS | DEAD | high |
| `clanarena.round.grace_no_fire` | Round-start grace period: weapons cannot be fired | MISS | MISS | MISS | - | - | DEAD | high |
| `clanarena.scoring.per_round_award` | Per-player ROUNDS_PL award at round start | MISS | MISS | - | - | - | DEAD | high |
| `clanarena.spawn.no_regen_forced_spectate` | No health/armor regen; dead players forced to spectate (no respawn calc) | ~ | - | ~ | - | - | ~ | low |
...
| `clanarena.spawn.forbid_throw_weapon` | Cannot drop/throw the current weapon | ? | - | - | - | - | ? | low |
...
| `ctf.flag.pickup` | Flag pickup (base + dropped) | ~ | ~ | OK | - | OK | live | high |
| `ctf.flag.capture` | Flag capture + caps/score/captime | ~ | ~ | OK | ~ | OK | live | high |
| `ctf.flag.return` | Flag return (player + auto/timeout) | ~ | ~ | OK | ~ | OK | live | high |
...
| `ctf.flag.throw` | Throw the flag (+use, g_ctf_throw) | OK | OK | OK | - | MISS | DEAD | high |
| `ctf.flag.pass` | Pass the flag to a teammate (g_ctf_pass) *(intended)* | ~ | OK | OK | - | MISS | DEAD | high |
| `ctf.flag.remove_player` | Carrier disconnect/observe/portal/vehicle drops flag | MISS | - | - | - | - | - | high |
...
| `ctf.stalemate` | Stalemate carrier reveal | MISS | MISS | MISS | MISS | - | - | high |
| `ctf.hud.modicons` | Flag-status mod-icon HUD (OBJECTIVE_STATUS) | OK | OK | OK | OK | - | DEAD | high |
...
| `cts.records.notifications` | Finish + record-set/improved/broken notifications (INFO_RACE_*) + medal status | stub | - | - | MISS | MISS | DEAD | high |
| `cts.finish.kill_delay_retract` | Finish kill-delay re-teleport to start (anti-speed-carry) | OK | ~ | OK | - | - | live | medium |
| `cts.physics.force_keyboard` | Forced keyboard movement quantization + race_movetime accumulator (PlayerPhysics) | MISS | MISS | MISS | - | - | - | high |
| `cts.combat.selfdamage` | Self-damage + fall-damage suppression (g_cts_selfdamage) | MISS | MISS | - | - | - | - | high |
| `cts.weapon.shotgun_only` | Shotgun-only loadout (WantWeapon → WEP_SHOTGUN) | MISS | MISS | - | - | - | - | high |
| `cts.weapon.no_drop_throw` | Forbid weapon throw + drop | MISS | - | - | - | - | - | high |
| `cts.death.respawn_rules` | Death rules: force respawn, instant CTS respawn, abandon run, remove projectiles | ~ | ~ | ~ | - | - | live | high |
| `cts.items.loot_filter` | Loot/monster-item filtering (g_cts_drop_monster_items) | MISS | MISS | - | - | - | - | medium |
| `cts.speedaward` | Speed award (per-round + all-time best speed) + name DB update | MISS | MISS | MISS | MISS | - | - | high |
| `cts.hud.race_timer` | Race timer HUD: running clock, checkpoint splits, anticipation, medal, PB/server-best | OK | OK | OK | ~ | - | DEAD | high |
| `cts.hud.cl_panel_gating` | CTS client panel gating (physics/strafe/race-timer shown, score/accuracy/item-stats hidden) | ~ | - | - | ~ | - | ~ | medium |
| `cts.map_reset` | Map reset: clear in-memory records, place event-log, qualifying==2 collapse | MISS | - | - | - | - | - | medium |
...
| `cts.records.getrecords` | Map-record listing reply (GetRecords): per-map rank-1 CTS time + holder | MISS | - | - | - | - | - | medium |
...
| `deathmatch.winconditions.leadlimit` | Lead limit ends the match (topscore - secondscore >= leadlimit) + leadlimit_and_fraglimit | MISS | MISS | MISS | - | - | - | high |
...
| `deathmatch.announce.frags_remaining` | Remaining-frags announcer (1/2/3 frags left) | MISS | MISS | MISS | MISS | MISS | - | high |
...
| id | name | L | V | T | P | A | live | conf |
|---|---|---|---|---|---|---|---|---|
| `domination.init.mutator_limits` | Mutator register + score/lead limit + team setup | ~ | ~ | OK | - | - | live | high |
| `domination.controlpoint.spawn` | Control point entity spawn (dom_controlpoint / team_dom_point) | OK | ~ | OK | MISS | - | live | high |
| `domination.capture.touch` | Instant point capture on player touch | ~ | ~ | ~ | - | - | live | high |
| `domination.scoring.tick` | Periodic per-point score tick to owning team + capturer | OK | OK | ~ | - | - | live | high |
| `domination.scoring.rules` | Scoreboard rules (ticks/caps/takes columns + sort keys) | OK | OK | - | OK | - | live | high |
| `domination.win.pointlimit` | Point-limit / lead-limit team win (tick variant) | OK | ~ | OK | - | - | live | high |
| `domination.roundbased.win` | Round-based variant: own-all-points round win + caps | ~ | ~ | ? | - | - | ~ | medium |
| `domination.capture.audio` | Capture sound (DOM_CLAIM) + narration (play2all) | MISS | - | - | - | MISS | DEAD | high |
| `domination.capture.notification` | Capture info notification (INFO_DOMINATION_CAPTURE_TIME) | MISS | - | - | MISS | - | DEAD | high |
| `domination.hud.modicons_pps` | Mod-icons HUD: per-team points-per-second bars | OK | OK | - | ~ | - | DEAD | high |
| `domination.waypoint.sprite` | Control point waypoint sprite + radar team color/ping | MISS | - | - | MISS | - | DEAD | high |
| `domination.bot.role` | Bot role: rate unclaimed/contested/enemy control points | ~ | OK | - | - | - | live | high |
...
| `duel.rules.player_limit_2` | Hard 1v1 player limit (GetPlayerLimit -> 2) | stub | OK | - | - | - | DEAD | high |
| `duel.items.powerup_filter` | Powerup item filter (block powerups unless g_duel_with_powerups) | stub | ~ | - | - | - | DEAD | high |
| `duel.scoring.frag_matrix` | Deathmatch frag/obituary scoring matrix (inherited) | OK | OK | OK | - | - | live | high |
| `duel.rules.match_end_latch` | End-of-match frag-limit latch + winner resolution | OK | OK | ~ | - | - | live | high |
| `duel.timing.respawn_delay` | Respawn delay (effective 2s via global fallback) | OK | OK | OK | - | - | live | high |
| `duel.presentation.duel_title` | Duel 'playerA vs playerB' centerprint title | stub | - | MISS | stub | - | DEAD | high |
...
| `freezetag.freeze.apply` | Freeze a fragged player (ice, HP=1, status effect, score matrix) | OK | OK | OK | ~ | - | live | high |
...
| `freezetag.unfreeze` | Unfreeze: clear ice state, restore health, re-enable | OK | ~ | OK | ~ | - | live | high |
| `freezetag.revive.manual` | Manual revive by nearby teammate (range geometry + progress) | ~ | ~ | ~ | - | - | live | high |
| `freezetag.revive.score` | Revive scoring (reviver +1, FREEZETAG_REVIVALS +1; revived player return) | ~ | ~ | - | - | - | live | high |
| `freezetag.revive.time_to_score` | Time-to-score revive model (revive_time_to_score / speed_t2s) | MISS | MISS | MISS | - | - | - | high |
| `freezetag.revive.auto_timeout` | Auto-thaw after g_freezetag_frozen_maxtime | ~ | OK | OK | - | - | live | high |
| `freezetag.revive.auto_reducible` | Hitting a frozen enemy speeds their auto-thaw (revive_auto_reducible) | MISS | MISS | MISS | - | - | - | high |
| `freezetag.damage.frozen_invuln` | Frozen players take 0 health damage + g_frozen_force knockback scaling | MISS | MISS | - | - | - | - | high |
| `freezetag.damage.softkill_void` | Frozen void/lava soft-kill teleport + g_frozen_damage_trigger; fall/nade revive | MISS | MISS | - | MISS | MISS | - | medium |
| `freezetag.revive.spawnshield` | Post-revive spawn shield (g_freezetag_revive_spawnshield) | MISS | MISS | MISS | - | - | - | high |
| `freezetag.round.flow` | Round handler flow (warmup/countdown/round/end-delay, ROUND_OVER tie) | ~ | ~ | OK | - | - | ~ | high |
| `freezetag.win.roundlimit` | Match win on round/lead limit (ST_FT_ROUNDS) | OK | ~ | OK | - | - | live | high |
| `freezetag.startitems` | FT start loadout (g_ft_start_health/armor/ammo) | OK | OK | - | - | - | DEAD | high |
...
| `freezetag.presentation.waypoints` | Frozen / Reviving waypoint sprites over frozen players | MISS | - | - | stub | - | DEAD | high |
| `freezetag.presentation.notifications` | Freeze/revive/self/auto-revive/spawn-late notifications (+ sounds) | MISS | - | - | stub | stub | DEAD | high |
| `freezetag.presentation.overlay_eventchase` | Full-screen frozen overlay tint + cl_eventchase_frozen cam + damage HUD | MISS | MISS | - | stub | - | DEAD | high |
| `freezetag.bots` | Bot freeing / offense roles + frozen-target gating | MISS | MISS | MISS | - | - | - | medium |
...
| `invasion.spawn.pick_monster` | Random monster pick with type filters + zombies-only | ~ | ~ | - | - | - | live | high |
| `invasion.spawn.pick_spawnpoint` | Spawn-point selection with recent-use de-weighting | ~ | ~ | MISS | - | - | live | high |
| `invasion.spawn.chosen_monster` | Spawn the chosen monster (NORESPAWN, skill stamp, think wired) | ~ | ~ | OK | - | - | live | high |
| `invasion.round.fill_and_win_round_mode` | ROUND fill loop + round-cleared advance / win | ~ | ~ | ~ | - | - | live | medium |
| `invasion.round.handler_wiring` | ROUND round_handler with Invasion-specific start/end/players callbacks + warmup + timelimit | ~ | MISS | MISS | - | - | DEAD | high |
| `invasion.round.timeout` | Round timeout: remove monsters, ROUND_OVER, restart round | MISS | MISS | MISS | MISS | - | - | high |
...
| `invasion.win.point_limit` | Match end on banked-kill point limit (default 50) | ~ | ~ | OK | - | - | live | medium |
| `invasion.rules.no_pvp_damage` | Player-vs-player damage cancelled (Damage_Calculate) | MISS | MISS | - | - | - | - | high |
| `invasion.rules.no_regen` | No health/armor regeneration (PlayerRegen) | MISS | - | - | - | - | - | high |
| `invasion.rules.start_items` | ROUND start items: 200 health / 200 armor (SetStartItems) | MISS | MISS | - | - | - | - | high |
| `invasion.bots.targeting` | Bot/monster targeting: monsters won't target players, bots only attack monsters | MISS | MISS | - | - | - | - | high |
| `invasion.notify.supermonster` | Center-print when a supermonster arrives (CENTER_INVASION_SUPERMONSTER) | MISS | - | - | MISS | - | DEAD | high |
| `invasion.notify.round_end` | Round-over / round-winner center+info prints | MISS | - | - | MISS | - | DEAD | high |
| `invasion.hud.monster_count` | HUD monsters_total / monsters_killed publish (SV_StartFrame) | MISS | - | - | MISS | - | DEAD | medium |
| `invasion.client.hide_item_stats` | Scoreboard hides the item-stats panel in Invasion (cl_invasion) | MISS | - | - | MISS | - | - | medium |

### `keepaway` (gametype) — 14 features

| id | name | L | V | T | P | A | live | conf |
|---|---|---|---|---|---|---|---|---|
| `keepaway.ball.spawn` | Ball spawn at map start (single keepawayball) | ~ | ~ | ? | MISS | - | DEAD | high |
| `keepaway.ball.respawn` | Loose-ball relocate timer + fall-off/NEEDKILL respawn | ~ | OK | ~ | MISS | MISS | DEAD | high |
| `keepaway.ball.pickup` | Ball pickup (attach to carrier, mark VIP, pickups++) | ~ | ~ | MISS | MISS | MISS | DEAD | high |
| `keepaway.ball.drop` | Ball drop on death/use-key/disconnect/observe | ~ | ~ | ~ | MISS | MISS | ~ | high |
| `keepaway.score.timepoints` | Per-second carry scoring (score_timepoints * frametime) | OK | OK | OK | - | - | DEAD | high |
| `keepaway.score.bctime` | Ball-carry-time secondary column (KEEPAWAY_BCTIME += frametime) | OK | OK | OK | - | - | DEAD | high |
| `keepaway.score.killbonuses` | Kill bonuses (bckill killer bonus + killac carrier bonus + carrierkills) | ~ | ~ | OK | - | - | ~ | high |
| `keepaway.win.pointlimit` | Point-limit win condition + leader | OK | ~ | - | - | - | live | medium |
| `keepaway.ffa.framing` | FFA framing (no teams) + tie -> overtime | OK | OK | - | - | - | live | high |
| `keepaway.damage.matrix` | Possession damage/force scaling matrix (Damage_Calculate) | OK | ~ | - | - | - | DEAD | high |
| `keepaway.carrier.highspeed` | Carrier speed multiplier (MOVEVARS_HIGHSPEED *= ballcarrier_highspeed) | MISS | MISS | MISS | - | - | - | high |
| `keepaway.hud.modicon` | Keepaway HUD mod-icon (blinking ball-carrying icon) | MISS | MISS | MISS | MISS | - | - | high |
| `keepaway.waypoints.tracking` | Ball / carrier waypoint sprites + radar tracking (g_keepawayball_tracking) | MISS | MISS | - | MISS | - | - | high |
| `keepaway.bot.role` | Bot ka roles (carrier/collector + ball goal rating + ForbidAttack) | ~ | OK | - | - | - | DEAD | high |

### `keyhunt` (gametype) — 21 features

| id | name | L | V | T | P | A | live | conf |
|---|---|---|---|---|---|---|---|---|
| `keyhunt.controller.round_loop` | Controller round loop: wait-for-players -> countdown -> start round | OK | ~ | OK | MISS | - | live | high |
| `keyhunt.round.spawn_keys` | Spawn one key per team onto a random live teammate at round start | OK | ~ | OK | ~ | - | live | high |
| `keyhunt.key.presentation_model` | Key model + team colormap + fullbright glow + per-team netname | OK | OK | - | OK | - | live | high |
| `keyhunt.key.carried_orbit` | Carried key orbits the carrier (XYSPEED circle); stops on drop | ~ | ~ | MISS | ~ | - | live | high |
| `keyhunt.key.touch_collect` | Touch by enemy collects a dropped key (+collect score, delay_collect re-pickup gate) | OK | ~ | OK | MISS | MISS | live | high |
| `keyhunt.capture.all_owned_and_in_range` | Capture: all keys on one team AND carriers within maxdist | OK | ~ | OK | - | - | live | high |
| `keyhunt.capture.instant_path_dead` | Instant capture-on-pickup path (no maxdist) — dead | ~ | - | - | - | - | DEAD | high |
| `keyhunt.capture.scoring` | Capture scoring: team SCORE + KH_CAPS | ~ | OK | - | - | - | live | medium |
| `keyhunt.round.finish_reset` | Finish round: remove keys, count down, restart | OK | OK | OK | MISS | - | live | high |
| `keyhunt.loss.timeout_return` | Dropped key auto-returns after delay_return | ~ | ~ | ~ | MISS | - | live | high |
| `keyhunt.loss.loser_team_push_destroy` | Loser team: push (score_push) vs destroyed (score_destroyed split) | MISS | MISS | MISS | MISS | MISS | - | high |
| `keyhunt.drop.on_death` | Drop all keys on death/suicide/observe/disconnect | ~ | ~ | ~ | MISS | MISS | ~ | medium |
| `keyhunt.drop.voluntary_use` | Voluntary +use drop of one key (kh_Key_DropOne) | MISS | MISS | MISS | MISS | MISS | - | high |
| `keyhunt.combat.carrier_damage_force` | Carrier/noncarrier damage + force multipliers | MISS | MISS | - | - | - | - | high |
| `keyhunt.combat.carrier_frag` | Carrier-frag bonus + team-kill penalty | ~ | ~ | - | - | - | live | medium |
| `keyhunt.unreachable.damage_destroy` | Lava/slime/trigger destroy + damage-return (return_when_unreachable) | MISS | MISS | MISS | - | - | - | high |
| `keyhunt.alarm.siren` | Periodic alarm while one team holds all keys | MISS | MISS | MISS | - | MISS | - | high |
| `keyhunt.notify.center_info` | Center-print + info notification storm (START/SCAN/ROUNDSTART/INTERFERE/MEET/HELP + PICKUP/DROP/LOST/PUSHED/DESTROYED/CAPTURE) + capture VFX | MISS | - | MISS | MISS | - | - | high |
...
| `keyhunt.bot.role` | Bot KeyHunt role (carrier/defense/offense/freelancer goal rating) | ~ | ~ | - | - | - | DEAD | high |
...
| `lms.lives.eliminate_at_zero` | At 0 lives the player is out of the game with a finishing rank | ~ | OK | ? | - | - | ~ | high |
...
| `lms.join.new_player_lives_gate` | Late-join lives gate (lowest-lives clamp + can't-join lockout) | OK | OK | - | - | - | DEAD | high |
| `lms.respawn.dynamic_delay` | Dynamic respawn delay scaling with lives behind the leader | ~ | OK | - | - | - | DEAD | high |
| `lms.loadout.start_items` | Fixed LMS start loadout (health/armor/ammo) + least-healthy late-join clone | MISS | MISS | - | - | - | - | high |
| `lms.loadout.weapon_arena` | LMS forces a weapon arena (most_available by default) | MISS | MISS | - | - | - | - | high |
| `lms.regen.disabled` | Health/armor regen and rot disabled in LMS | MISS | MISS | - | - | - | - | high |
| `lms.items.no_pickups` | Item pickups suppressed (HealthMega->ExtraLife when enabled) | MISS | MISS | - | - | - | - | high |
| `lms.leader.computation` | Leader detection (max-lives players with a large enough, small enough lead) | OK | OK | OK | - | - | ~ | high |
| `lms.leader.glow` | Leader glow effect (EF_ADDITIVE | EF_FULLBRIGHT) | MISS | - | - | MISS | - | - | high |
| `lms.leader.waypoint` | Leader radar waypoint with periodic visibility window | MISS | MISS | MISS | MISS | - | - | high |
| `lms.leader.notifications` | Leader visibility centerprints (VISIBLE_LEADER / VISIBLE_OTHER) | MISS | - | MISS | stub | - | DEAD | high |
| `lms.hud.mod_icon` | HUD mod-icon: leader count + colored +N lives lead | MISS | - | - | MISS | - | - | high |
| `lms.hud.no_lives_message` | Info message: 'You have no more lives left' (eliminated local player) | MISS | - | - | stub | - | DEAD | high |
| `lms.damage.dynamic_vampire` | Dynamic vampire: under-dogs steal health when hitting leaders | MISS | MISS | - | - | - | - | high |
| `lms.item.extra_life` | Extra-life pickups grant lives | ~ | OK | - | ? | - | DEAD | high |
| `lms.scoreboard.columns` | LMS scoreboard columns (lives + rank, sorted rank-then-lives) | OK | OK | - | OK | - | ~ | high |
| `lms.forfeit.remove_player` | Disconnect/forfeit assigns a rank and reshuffles other ranks | MISS | - | - | - | - | DEAD | high |
| `lms.rules.no_throw_and_spec_lockout` | Can't drop weapon; ranked-out players can't become spectators | MISS | - | - | - | - | - | high |
...
| `mayhem.loadout.weapon_arena` | SetWeaponArena — grant the full arsenal (most_available) at spawn | ~ | OK | - | - | - | DEAD | high |
...
### `nexball` (gametype) — 17 features

| id | name | L | V | T | P | A | live | conf |
|---|---|---|---|---|---|---|---|---|
| `nexball.init.initialize` | Mode init: teams, score/lead limit, meter-period rounding, radar | ~ | ~ | - | - | - | live | high |
| `nexball.score.scorerules` | Score rules: team ST_NEXBALL_GOALS, player goals + faults columns | OK | OK | - | - | - | live | high |
| `nexball.goal.touch_scoring` | GoalTouch: enemy goal +1, own-goal/fault -1 (credited to other team in 2-team), out returns | OK | OK | ~ | MISS | MISS | ~ | high |
| `nexball.goal.limit_win` | Goal limit + winning-team latch (GameRules_limit_score) | OK | ~ | - | - | - | live | high |
| `nexball.goal.tie_overtime` | Tied-goals reports a tie (timed-match overtime instead of draw) | OK | - | - | - | - | live | medium |
| `nexball.ball.spawn` | Ball spawn: world ball entity, home origin, model/scale/trail/effects | ~ | ~ | MISS | MISS | - | live | high |
| `nexball.ball.lifecycle` | Ball lifecycle thinks: delay_start release, 4-step ResetBall glide, idle reset | MISS | MISS | MISS | MISS | MISS | - | high |
| `nexball.ball.football_kick` | Football kick physics (soccer-style velocity boost on touch) | MISS | MISS | MISS | MISS | MISS | - | high |
| `nexball.ball.basketball_pickup` | Basketball pickup gating (cnt, health, dropper delay_collect, carrier bump) | ~ | MISS | MISS | - | - | live | high |
| `nexball.ball.giveball` | GiveBall: ownership, carry effects, forteam lifetime, weapon-arena swap | ~ | MISS | MISS | MISS | - | live | high |
| `nexball.ball.dropball` | DropBall / DropOwner / drop on death/disconnect/observe | ~ | MISS | MISS | MISS | - | ~ | high |
| `nexball.carry.perframe` | Carry per-frame: view-ball follow, safe-pass lock, carrier-slowdown, carrying status | MISS | MISS | MISS | MISS | - | - | high |
...
| `nexball.weapon.power_meter` | Basketball power meter (charge-and-release launch strength) | MISS | MISS | MISS | MISS | - | - | high |
| `nexball.sound.cues` | Sound cues: bounce / drop / steal / shoot / goal | - | - | - | - | MISS | DEAD | high |
...
### `onslaught` (gametype) — 17 features

| id | name | L | V | T | P | A | live | conf |
|---|---|---|---|---|---|---|---|---|
| `onslaught.graph.power_propagation` | Power graph + shielding propagation (onslaught_updatelinks) | OK | - | - | - | - | ~ | high |
| `onslaught.links.resolution` | onslaught_link map entity → graph edges | MISS | - | - | - | - | DEAD | high |
| `onslaught.cp.touch_build` | Control-point capture-by-build (touch → icon → build → flip) | OK | ~ | OK | MISS | MISS | ~ | high |
| `onslaught.cp.icon_damage` | Capture-icon damage / destroy mid-build (revert to neutral) | OK | OK | OK | MISS | MISS | ~ | high |
| `onslaught.cp.icon_think_regen` | Built-icon steady-state slow regen | OK | ~ | OK | - | MISS | ~ | medium |
| `onslaught.cp.icon_heal` | Capture-icon heal (Healer mutator / heal trigger) | OK | OK | - | - | - | DEAD | high |
| `onslaught.gen.damage_destroy` | Generator shield-gated damage + destruction | OK | ~ | OK | MISS | MISS | ~ | high |
| `onslaught.round.handler` | Round handler (warmup → countdown → round → end-delay) | OK | ~ | ~ | - | MISS | live | medium |
| `onslaught.win.check_winner` | Win check (last standing generator) + ST_ONS_GENS credit | OK | OK | OK | MISS | MISS | live | high |
| `onslaught.overtime.decay` | Overtime generator self-decay (sudden death) | OK | OK | OK | - | MISS | ~ | medium |
...
| `onslaught.cp.proximity_decap` | Proximity de-capture (stand near a point to flip it) | MISS | MISS | MISS | MISS | - | - | high |
...
| `onslaught.audio.cues` | Onslaught notifications + sounds emission | - | - | - | MISS | MISS | DEAD | high |
| `onslaught.bot.roles` | Bot Onslaught objective role (offense/defense/assistant goal rating) | ~ | MISS | MISS | - | - | live | high |
...
| `race.checkpoint.ordered_crossing` | Ordered checkpoint crossing detection + advance | ~ | OK | - | - | - | live | high |
...
| `race.records.notifications` | Record result + finish/abandon notifications (INFO_RACE_*) | stub | - | - | stub | stub | DEAD | high |
| `race.penalty.zones` | Penalty zones (freeze in race / accumulate in qualifying) | ~ | OK | OK | - | - | live | high |
| `race.win.condition` | Win condition: everyone-finished + lap-limit + sudden-death run-on | ~ | OK | - | - | - | live | high |
...
| `race.qualifying.transition` | Qualifying-then-race transition (g_race_qualifying==2 -> 0) | stub | - | MISS | - | - | DEAD | high |
| `race.spawn.grid_respawn` | Spawn grid by race_place + respawn at last checkpoint | MISS | MISS | - | - | - | DEAD | medium |
| `race.movement.quantization` | Force-keyboard movement quantization + race_movetime + FixClientCvars | MISS | MISS | MISS | - | - | - | high |
| `race.hud.split_timer` | Race split timer HUD panel (#8): running clock, splits, anticipation, medals | OK | OK | OK | ~ | - | DEAD | high |
| `race.hud.checkpoint_splits` | Checkpoints split list panel (#27) | OK | OK | - | ~ | - | DEAD | high |
| `race.bot.role` | Bot race role (navigate the checkpoint track) | MISS | MISS | - | - | - | - | high |
| `race.hud.mod_icon_rankings` | Race/CTS mod-icon (PB + server best + medals) and Rankings scoreboard column | MISS | MISS | - | MISS | - | - | high |
...
| `survival.round.assign_roles` | Round start secretly assigns hunters (live-only count, bounded, random pick) | OK | OK | ? | - | - | live | high |
| `survival.round.handler` | Round-handler driven warmup/countdown/round/end-delay cycle | ~ | ~ | ? | - | - | ~ | medium |
| `survival.scoring.bank_validkills` | Kills bank into validkills during the round (no immediate score) | OK | ~ | ~ | - | - | live | high |
| `survival.scoring.round_end_award` | Round end awards banked kills + per-side bonuses (survivals/hunts, reward_survival) | OK | OK | ~ | - | - | ~ | high |
...
| `survival.win.side_wipe` | Side-wipe win latch (hunters win if any hunter alive, else prey) | OK | OK | ~ | - | - | live | high |
| `survival.win.timeout` | Round timer / match timeout -> survivors win | MISS | ~ | MISS | - | - | DEAD | high |
| `survival.death.eliminate` | Death eliminates the player for the round (no respawn) | OK | OK | ~ | - | - | live | medium |
| `survival.death.punish_teamkill` | Killing an ally auto-kills the killer + docks frags | MISS | MISS | - | - | - | - | high |
...
| `survival.presentation.player_colors_and_notifications` | Player green/red coloring + role/win center & info notifications | MISS | ~ | - | MISS | - | DEAD | high |
| `survival.bot.forbid_attack_allies` | Bots never attack same-status (ally) players | MISS | - | - | - | - | - | high |
| `survival.notify.last_survivor_alone` | Last living member of a side gets the 'you are alone' center notify | MISS | - | - | MISS | - | - | high |

### `tdm` (gametype) — 13 features

| id | name | L | V | T | P | A | live | conf |
|---|---|---|---|---|---|---|---|---|
| `tdm.identity.registration` | TDM gametype identity + default match limits (timelimit=15 pointlimit=50 teams=2 leadlimit=0) | OK | ~ | - | - | - | live | high |
...
| `tdm.scoring.player_frag` | Per-player SP_SCORE frag credit (each frag also lands on the killer's individual score) | MISS | MISS | - | - | - | - | high |
| `tdm.rules.point_limit` | Team point-limit end-of-match (g_tdm_point_limit; -1 = use mapinfo 50) | ~ | ~ | OK | - | - | live | high |
| `tdm.rules.lead_limit` | Team lead-limit end-of-match (g_tdm_point_leadlimit; -1 = use mapinfo 0) | OK | OK | OK | - | - | live | medium |
...
| `tdm.presentation.remaining_frags` | Remaining-frags team announcer (ANNCE_REMAINING_FRAG_1/2/3) | MISS | MISS | MISS | MISS | MISS | - | high |
...
| id | name | L | V | T | P | A | live | conf |
|---|---|---|---|---|---|---|---|---|
| `tka.ball.spawn` | Ball spawn at match start (g_tkaball_count balls) | ~ | ~ | ? | MISS | - | DEAD | high |
| `tka.ball.respawn` | Loose-ball relocate timer + fall-off respawn | ~ | ~ | ~ | MISS | MISS | DEAD | high |
| `tka.ball.pickup` | Ball pickup (attach to carrier, VIP, pickups++, orbit anim) | ~ | ~ | MISS | MISS | MISS | DEAD | high |
| `tka.ball.drop` | Ball drop on death / use-key / disconnect / observe | ~ | ~ | ~ | MISS | MISS | ~ | high |
| `tka.score.teamkill` | Team kill scoring (killac to team while team holds ball) | ~ | ~ | OK | - | - | ~ | high |
| `tka.score.scoreteam` | g_tka_score_team: any teammate's kill scores while team holds ball | MISS | MISS | - | - | - | - | high |
| `tka.score.bckill` | Ball-carrier-kill bonus (bckill to team) + carrierkills column | ~ | ~ | OK | - | - | ~ | high |
| `tka.score.bctime` | Ball-carry-time secondary column (TKA_BCTIME += frametime) | MISS | ~ | MISS | - | - | DEAD | high |
| `tka.score.timepoints` | Timed possession points to TEAM score (g_tka_score_timepoints) | MISS | MISS | MISS | - | - | - | high |
| `tka.score.nofrags` | No DM frags (GiveFragsForKill zeroed) + reset_map_global | ~ | MISS | - | - | - | ? | medium |
| `tka.damage.matrix` | Possession damage/force scaling matrix (Damage_Calculate) | ~ | ~ | - | - | - | DEAD | high |
| `tka.carrier.highspeed` | Carrier speed multiplier (MOVEVARS_HIGHSPEED *= g_tka_ballcarrier_highspeed) | MISS | MISS | MISS | - | - | - | high |
| `tka.win.pointlimit` | Team point-limit + lead-limit win condition | ~ | ~ | - | - | - | live | high |
| `tka.team.framing` | Team framing (teams 2..4, team spawns) + tie -> overtime | OK | OK | - | - | - | live | high |
| `tka.hud.modicon` | TKA HUD mod-icon + TKA_BALLSTATUS stat (team ball-taken icons) | MISS | MISS | MISS | MISS | - | - | high |
| `tka.waypoints.tracking` | Team-colored carrier / ball waypoints + radar tracking | MISS | MISS | - | MISS | - | - | high |
| `tka.bot.role` | Bot TKA roles (carrier/collector, team-aware goalrating, ForbidAttack) | ~ | ~ | - | - | - | DEAD | high |
...
| `tmayhem.loadout.weapon_arena` | SetWeaponArena — grant the full arsenal (most_available) at spawn | ~ | OK | - | - | - | DEAD | high |
...
| `items-pickups.give.item_giveto` | Item_GiveTo / Item_GiveAmmoTo — the type-agnostic give toward a cap | ~ | OK | - | - | - | live | high |
...
| `mapobject-func.reset` | Map-object .reset / .reset2 pass on round/match restart (reset_map_global entity-reset) | MISS | - | - | - | - | DEAD | high |
| `mapobject-func.door.slide` | func_door — sliding door state machine, LinkDoors groups, field, touch/use/blocked | ~ | OK | OK | ~ | ~ | live | high |
| `mapobject-func.door.rotating` | func_door_rotating — swinging door (angle-move between two angle positions) | ~ | OK | OK | ~ | ~ | live | high |
| `mapobject-func.door.keys` | func_door key locks (gold/silver itemkeys, consume + locked/unlocked sounds) | OK | OK | OK | MISS | ~ | live | high |
| `mapobject-func.button` | func_button — press-to-fire (touch/use/damage), wait+return, setactive timer, alt texture *(intended)* | ~ | OK | OK | ~ | OK | live | high |
| `mapobject-func.plat` | func_plat — riding platform (center trigger raises, 3s top dwell, crush/reverse) | OK | OK | OK | ~ | ~ | live | high |
| `mapobject-func.train` | func_train — path_corner chain ride (TURN/CURVE/NEEDACTIVATION/random, per-corner speed/wait) | ~ | OK | OK | ~ | ~ | live | medium |
...
| `mapobject-func.breakable` | func_breakable / misc_breakablemodel — destructible BSP (debris, blast, respawn) *(intended)* | ~ | ~ | OK | ~ | OK | live | high |
| `mapobject-func.door_secret` | func_door_secret — Quake-1 secret door (slide back/down, then sideways, return, re-arm) *(intended)* | OK | OK | OK | ~ | ~ | live | high |
...
| `mapobject-misc.follow.attach_follow` | misc_follow attach / MOVETYPE_FOLLOW ride at spawn | OK | OK | OK | ~ | - | live | high |
| `mapobject-misc.dynlight.server_state` | dynlight static/follow/tag/path modes + toggle + reset (server) | ~ | OK | OK | - | - | live | high |
| `mapobject-misc.dynlight.render` | dynlight realtime light (radius/color/style render) | - | - | - | MISS | - | - | high |
| `mapobject-misc.keys.item_key` | item_key* pickup keys (spawn, touch, grant itemkeys, model rotate) | MISS | MISS | MISS | MISS | MISS | - | high |
| `mapobject-misc.teleport_dest.marker` | info_teleport_destination / misc_teleporter_dest endpoint | OK | OK | - | - | - | live | high |
| `mapobject-misc.corner.path_corner` | path_corner waypoint + per-corner platmovetype override (set_platmovetype) | ~ | ~ | OK | - | - | live | high |
| `mapobject-misc.subs.calcmove` | SUB_CalcMove / SUB_CalcAngleMove mover driver (linear + bezier + cubic_speedfunc) | OK | ~ | ~ | - | - | live | high |
...
| id | name | L | V | T | P | A | live | conf |
|---|---|---|---|---|---|---|---|---|
| `mapobject-movers-platforms.plat.spawn_setup` | func_plat spawnfunc: defaults, pos1/pos2, brush init, reset | OK | ~ | - | - | ~ | live | high |
| `mapobject-movers-platforms.plat.q3compat_defaults` | Q3/Q3DF compat: speed 200, lip 8, dmg 2, medplat sounds, CPMA sound keys | MISS | MISS | - | - | MISS | - | high |
...
| `mapobject-movers-platforms.plat.trigger_use` | plat_trigger_use / plat_use: external trigger send-down | ~ | - | OK | - | - | live | high |
| `mapobject-movers-platforms.plat.crush` | plat_crush: CRUSH instakill / .dmg bite + reverse | OK | OK | - | - | - | live | high |
| `mapobject-movers-platforms.plat.reset` | plat_reset: targeted=start-raised, else start-bottom | ~ | - | - | - | - | live | high |
| `mapobject-movers-platforms.plat.outside_target_use` | plat_outside_touch / plat_target_use (Q3 + mapper-wired) | MISS | - | - | - | - | - | high |
| `mapobject-movers-platforms.subs.calcmove` | SUB_CalcMove mover driver (linear branch + bezier easing) | OK | OK | OK | - | - | live | high |
| `mapobject-movers-platforms.subs.platmovetype_parse` | set_platmovetype / cubic_speedfunc_is_sane (platmovetype key parse + sanity reject) | MISS | MISS | - | - | - | - | medium |
...
| `mapobject-target.changelevel.use` | target_changelevel — end / switch the level (multiplayer fraction) | ~ | ~ | - | - | - | DEAD | high |
| `mapobject-target.levelwarp.use` | target_levelwarp — campaign level warp | OK | - | - | - | - | DEAD | high |
| `mapobject-target.give.use` | target_give — give the activator the items pointed to | OK | OK | - | - | OK | live | medium |
| `mapobject-target.items.use` | target_items — set/add items + resources + powerups via a token string | ~ | OK | - | ~ | ~ | live | high |
| `mapobject-target.spawn.use` | target_spawn — data-driven entity creator/editor ($-templating) *(intended)* | stub | - | - | - | - | DEAD | high |
| `mapobject-target.speaker.ambient_triggered` | target_speaker — ambient / looped / one-shot / activator sound emitter | ~ | ~ | - | - | ~ | live | medium |
...
| `teleporters.core.telefrag` | tdeath box telefrag with self-gib for dead/monster teleportees | ~ | ~ | OK | - | - | live | high |
| `teleporters.core.telefrag_teamplay` | Teammates spared from telefrag in team modes (g_telefrags_teamplay) | ~ | ~ | - | - | - | live | high |
| `teleporters.core.telefrag_cvars` | g_telefrags / g_telefrags_avoid cvars honored at runtime | ~ | OK | - | - | - | live | high |
...
| `teleporters.trigger.active_gate` | Teleport_Active gating (active/dead/team/observers-only/turret/vehicle) | ~ | ~ | - | - | - | live | high |
| `teleporters.trigger.touch_and_targets` | Teleport_Touch + SUB_UseTargets firing | ~ | - | OK | - | - | live | high |
| `teleporters.trigger.team_claim` | trigger_teleport_use team claim | ~ | - | - | - | - | ? | low |
...
| `teleporters.fx.flash` | Teleport flash effect at both ends | OK | ~ | OK | ~ | - | live | high |
| `teleporters.fx.sound` | Teleport sound (misc/teleport, debounced) | OK | OK | OK | - | ~ | live | medium |
| `portals.weapon.projectile` | Porto projectile launch/bounce/lifetime/one-portal latch | ~ | OK | OK | ~ | OK | live | medium |
...
| `portals.weapon.cleanup` | Portal pair lifecycle: one pair per owner, death/timeout clears both, ID-clear | ~ | - | MISS | - | - | ~ | medium |
| `portals.weapon.hook_and_predict` | Portal grappling-hook teleport + predict-ahead crossing (Portal_WillHitPlane) | MISS | MISS | MISS | - | - | - | medium |
...
| `mapobject-triggers.hurt.trigger_hurt` | trigger_hurt — damage volume | ~ | OK | OK | - | - | live | high |
| `mapobject-triggers.heal.trigger_heal` | trigger_heal / target_heal — heal volume / relay | ~ | OK | OK | - | ~ | live | high |
...
| `mapobject-triggers.secret.trigger_secret` | trigger_secret — secrets-found counter trigger | OK | OK | - | ~ | OK | live | high |
| `mapobject-triggers.counter.trigger_counter` | trigger_counter — fire after N uses (+ per-player) | OK | OK | OK | MISS | ~ | live | high |
...
| `mapobject-triggers.magicear.trigger_magicear` | trigger_magicear — chat pattern match -> SUB_UseTargets / text replace | ~ | OK | - | - | - | DEAD | high |
| `mapobject-triggers.keylock.trigger_keylock` | trigger_keylock — fire target when all required keys supplied | OK | OK | OK | ~ | OK | live | high |
| `mapobject-triggers.teleport.trigger_teleport` | trigger_teleport / target_teleporter — player teleport source *(intended)* | OK | OK | OK | OK | ? | live | medium |
| `mapobject-triggers.music.target_music` | target_music / trigger_music — map music overrides | OK | ~ | ~ | ~ | OK | live | medium |
...
| `warpzones.teleport.player` | Player/projectile crossing: warp origin/velocity/angles, momentum-preserved | ~ | OK | OK | - | - | live | high |
| `warpzones.teleport.usetargets` | Fire warpzone targets on a crossing (SUB_UseTargets) | ~ | - | - | - | - | live | medium |
...
| `warpzones.client.prediction` | Client-side prediction of a warpzone crossing | MISS | - | MISS | MISS | - | - | high |
...
| `monster-framework.spawn.setup` | Field stamping + defaults (Monster_Spawn_Setup / Setup) | OK | OK | OK | ~ | - | live | high |
| `monster-framework.spawn.miniboss` | Miniboss setup (Monster_Miniboss_Setup) | ~ | OK | - | MISS | - | live | high |
...
| `monster-framework.target.find_enemycheck` | Target acquisition + enemy retention (Monster_FindTarget / Monster_Enemy_Check) | ~ | ~ | OK | - | ~ | live | high |
| `monster-framework.move.brain` | Movement brain (Monster_Move / Move_Target / WanderTarget) | ~ | OK | ~ | - | ~ | live | high |
| `monster-framework.move.danger` | Edge/lava danger avoidance (Monster_CheckDanger) | ~ | OK | - | - | - | live | high |
| `monster-framework.attack.dispatch` | Attack gating + dispatch (Monster_Attack_Check) | OK | OK | OK | - | ~ | live | high |
| `monster-framework.attack.primitives` | Melee / leap / projectile primitives (Monster_Attack_Melee/Leap + projectile spawns) | OK | OK | OK | - | - | live | high |
| `monster-framework.damage.pain_death` | Pain / death / corpse (Monster_Damage / Monster_Dead / Monster_Dead_Damage) *(intended)* | OK | OK | ~ | - | ~ | live | high |
...
| `monster-framework.presentation.healthbar_sounds_anim` | Presentation: healthbar sprite + monster sounds + CSQC anim *(intended)* | ~ | MISS | MISS | MISS | ~ | ~ | high |
...
| `monster-golem.attack.lightning` | Ranged lightning chunk: bouncing shootable projectile, 5s fuse | OK | OK | OK | MISS | ~ | live | medium |
...
| `monster-golem.audio.voice_cues` | Monster_Sound voice cues (idle/sight/melee/spawn/pain/death) + antilag throttle | ~ | ~ | MISS | - | ~ | ~ | high |
...
| id | name | L | V | T | P | A | live | conf |
|---|---|---|---|---|---|---|---|---|
| `monster-mage.spawn.setup` | Spawn + mr_setup (health, speeds, loot, size, attackfunc) | OK | OK | OK | - | - | live | high |
| `monster-mage.attack.select` | Attack selection (melee push vs ranged teleport/spike) *(intended)* | OK | OK | OK | - | - | live | high |
| `monster-mage.attack.spike` | Homing electric spike (one in flight, seeker guidance) | OK | ~ | OK | MISS | ~ | live | high |
| `monster-mage.attack.push` | Explosive close-range push (AoE shove) | OK | OK | OK | MISS | OK | live | high |
| `monster-mage.attack.teleport` | Teleport behind / random-relocate near the target | ~ | ~ | OK | MISS | ~ | live | high |
| `monster-mage.defend.shield` | Self damage-blocking shield | ~ | ~ | OK | - | ~ | live | high |
| `monster-mage.defend.heal` | Radius heal of self/allies (skin variants: health/ammo/armor) | ~ | OK | OK | MISS | ~ | live | high |
| `monster-mage.think.decide` | Per-think heal/shield decision (mr_think) | OK | OK | OK | - | - | live | high |
| `monster-mage.death.pain` | Pain reaction + death anim (mr_pain / mr_death) | OK | OK | OK | ~ | OK | live | medium |
...
| `monster-spider.attack.web_projectile` | Ranged web projectile (bouncing plasma, no direct damage) | OK | OK | OK | ~ | OK | live | high |
...
| `monster-spider.web.electro_impact_fx` | Web explosion EFFECT_ELECTRO_IMPACT particle | - | - | - | MISS | - | - | high |
...
| `monster-spider.menu.describe` | MENUQC monster-tooltip description text | ? | ? | - | ? | - | ? | low |
...
| `wyvern.fireball.burning` | Fireball ignites everything in radius (burning DoT) | OK | ~ | ~ | - | - | live | medium |
| `wyvern.fireball.explode_effect` | Fireball blast particle (EFFECT_FIREBALL_EXPLODE) | MISS | - | - | MISS | - | - | high |
| `wyvern.fireball.firemine_visual` | In-flight fireball CSQC visual (PROJECTILE_FIREMINE) | MISS | - | - | MISS | - | - | high |
...
| `wyvern.pain` | Pain reaction (0.5s window, pain anim) | OK | ~ | ~ | stub | - | live | high |
| `wyvern.death` | Death: die anim + random corpse launch scatter | ~ | MISS | - | MISS | - | live | high |
| `wyvern.deadthink` | Dead-think: swap to anim_die2 once the corpse lands | MISS | - | - | MISS | - | - | high |
| `wyvern.anim.frame_table` | Animation frame groups (mr_anim) | stub | MISS | - | stub | - | DEAD | high |
...
| `wyvern.menu.describe` | MENUQC monster-tooltip description text | ? | ? | - | ? | - | ? | low |
...
| `monster-zombie.setup.mr_setup` | Spawn setup: always-respawn at death point, loot, spawn shield, no-push spawn window | OK | OK | ~ | - | - | live | high |
| `monster-zombie.think.forcescale_restore` | Per-think: restore knockback scale after spawn animation | OK | OK | OK | - | - | live | high |
| `monster-zombie.attack.melee` | Melee attack: 3-way anim roll + forward traceline damage | OK | OK | OK | MISS | - | live | high |
| `monster-zombie.attack.block` | Defend block: raise armor + freeze when hurt vs healthy enemy | OK | ~ | OK | MISS | ~ | live | high |
| `monster-zombie.attack.leap` | Leap attack: ballistic toss toward enemy when at range | OK | OK | OK | MISS | - | live | medium |
| `monster-zombie.attack.leap_touch` | Leap contact: contact damage + knockback, then disarm to stop spam | OK | OK | OK | - | - | live | high |
| `monster-zombie.pain.mr_pain` | Pain reaction: brief pain window + pain anim + (added) hurt sound | OK | OK | OK | MISS | ~ | live | high |
| `monster-zombie.death.mr_death` | Death: corpse + death anim + death sound + respawn machinery | OK | OK | OK | MISS | OK | live | high |
| `monster-zombie.respawn.undead` | Always-respawn at death point (undead): corpse rises unless gibbed | OK | OK | OK | - | - | live | medium |
| `monster-zombie.presentation.animation` | Zombie model animation (mr_anim frame groups) | - | MISS | MISS | MISS | - | DEAD | high |
...
| `mutator-bloodloss.threshold.live_reread` | Threshold value tracks the g_bloodloss cvar mid-match | ~ | ~ | - | - | - | live | high |
| `mutator-bloodloss.presentation.active_mutator_signalling` | Active-mutators serverinfo + scoreboard/HUD signalling (BuildMutatorsString, util MUT_BLOODLOSS row, CSQC mut_set_active) | MISS | MISS | - | MISS | - | - | high |
...
| `breakablehook.owner.punish_splash` | Punish hook owner with 5 splash + remove on cross-team break | ~ | OK | OK | - | - | live | high |
| `breakablehook.remove.drop_chain` | Remove the hook chain when broken (RemoveHook proxy) *(intended)* | OK | - | OK | - | - | live | medium |
| `breakablehook.cvar.live_reread` | Live per-call cvar read (mid-match toggling of breaking rules) | ~ | OK | ~ | - | - | live | high |
...
| `buffs.item.touch_pickup` | Buff pickup + autoreplace on touch | ~ | OK | OK | ~ | ~ | ~ | high |
| `buffs.item.needkill_respawn` | Buff item lava/needkill respawn on touch (ITEM_TOUCH_NEEDKILL) | MISS | - | - | MISS | MISS | - | high |
| `buffs.item.respawn_cooldown` | Buff item cooldown / respawn cycle (buff_Think + buff_SetCooldown) | ~ | OK | ~ | MISS | MISS | ~ | medium |
| `buffs.item.random_location` | Random location / lifetime / randomize-on-reset (buff_Respawn / buff_Reset) | ~ | MISS | MISS | MISS | MISS | DEAD | high |
| `buffs.item.new_type_weighting` | Weighted random buff selection (buff_NewType / seencount) *(intended)* | ~ | ~ | - | - | - | ~ | high |
| `buffs.item.available` | buff_Available (per-buff enable + exclusions) | ~ | OK | - | - | - | ~ | high |
| `buffs.resistance` | Resistance buff — damage reduction | OK | OK | OK | - | - | live | high |
| `buffs.medic.survive` | Medic buff — survive a fatal hit | ~ | OK | OK | - | - | live | high |
...
| `buffs.jump.velocity` | Jump buff — increased jump height | ~ | OK | - | - | - | DEAD | high |
...
| `buffs.vengeance` | Vengeance buff — reflect damage to attacker | ~ | OK | OK | - | - | live | high |
| `buffs.luck` | Luck buff — chance of a critical hit | OK | OK | OK | - | - | live | high |
| `buffs.ammo` | Ammo buff — unlimited ammo + no reload | ~ | OK | OK | - | - | live | medium |
| `buffs.magnet` | Magnet buff — auto-collect nearby items | ~ | OK | OK | - | - | live | medium |
| `buffs.flight` | Flight buff — crouch-in-air gravity flip | ~ | OK | OK | - | - | live | high |
| `buffs.inferno` | Inferno buff — burn-on-hit + fire/lava resistance | MISS | MISS | MISS | MISS | - | - | high |
| `buffs.swapper` | Swapper buff — swap places with nearest enemy | MISS | MISS | MISS | MISS | MISS | - | high |
...
| `buffs.drop` | Drop held buff (PlayerUseKey / g_buffs_drop) | MISS | ~ | - | - | MISS | - | high |
| `buffs.replace_powerups` | Replace map powerups with buffs (FilterItem) | MISS | MISS | - | - | - | - | high |
| `buffs.mutator_string` | Report as active mutator (BuildMutatorsString / PrettyString) | MISS | MISS | - | - | - | - | high |
| `buffs.notifications` | Buff pickup/loss/drop notifications + sounds | ~ | - | OK | ~ | ~ | ~ | high |
...
| `mutator-bugrigs.clientconnect.chase_camera` | Force 3rd-person chase camera on player connect (chase_active 1) | MISS | MISS | MISS | MISS | - | - | high |
| `mutator-bugrigs.serverinfo.mutator_strings` | Advertise mutator in active-mutator strings (:bugrigs / , Bug rigs) | MISS | MISS | - | MISS | - | - | high |
...
| `campcheck.death.obituary` | DEATH_CAMP obituary: 'Die camper!' / 'thought they found a nice camping ground' | ~ | MISS | - | MISS | - | DEAD | high |
| `campcheck.realclient.gate` | Real-clients-only / not-typing / not-weapon-locked guard chain | MISS | MISS | - | - | - | - | high |
| `campcheck.prematch.reset` | Pre-match / round-not-started reset of timer + distance *(intended)* | ~ | MISS | ~ | - | - | live | high |
| `campcheck.lifecycle.misc` | PlayerDies centerprint clear, CopyBody clone origin, BuildMutatorsString advertise | stub | MISS | - | stub | - | DEAD | high |
...
| `mutator-cloaked.alpha.set_default_alpha` | SetDefaultAlpha override — set player/weapon alpha from g_balance_cloaked_alpha | stub | OK | MISS | MISS | - | DEAD | high |
| `mutator-cloaked.alpha.default_alpha_consumers` | default_player_alpha / default_weapon_alpha applied at spawn, death, weapon entities, vehicle-exit; networked + rendered | MISS | MISS | MISS | MISS | - | - | high |
| `mutator-cloaked.report.mutators_pretty_string` | Active-mutators string contribution (', Cloaked' + MUT_CLOAKED bit) | MISS | MISS | - | MISS | - | - | high |
| `mutator-cloaked.menu.metadata` | MENUQC metadata (describe text + create-game checkbox) | MISS | MISS | - | MISS | - | - | high |
| `mutator-cloaked.compose.invisibility_powerup` | Composition with Invisibility powerup (expiry returns to default_player_alpha, i.e. cloaked alpha under cloaked) | ~ | MISS | - | MISS | - | DEAD | high |
...
| `damagetext.sv.first_hit_bitset` | Per-victim first-hit-after-respawn set (dent_attackers -> STOP_ACCUMULATION; spawn/disconnect clears) | ~ | OK | - | - | - | live | high |
...
| `damagetext.cl.placement_2d_3d` | 2D-vs-3D placement heuristics (close-range / out-of-view / spectating, overlap stagger) | MISS | MISS | MISS | MISS | - | DEAD | high |
| `damagetext.cl.draw_fade_shrink_move` | Per-frame draw: fade, shrink, world/screen drift, centering, color codes, font | ~ | ~ | OK | ~ | - | live | medium |
| `damagetext.ui.settings_tab` | In-game Damage Text settings menu tab | MISS | MISS | - | MISS | - | - | high |
...
| `mutator-dodging.input.double_tap` | Double-tap detection (PM_dodging_checkpressedkeys) | ~ | OK | ? | - | - | DEAD | high |
| `mutator-dodging.input.delay_state_gate` | Delay cooldown + ground/wall/air state gating | OK | ~ | ? | - | - | DEAD | high |
| `mutator-dodging.force.scaling` | Speed-to-force scaling (determine_force / map_bound_ranges) | ~ | ~ | - | - | - | DEAD | high |
| `mutator-dodging.move.ramp_impulse` | Per-frame ramp + one-shot up-impulse (PM_dodging) | ~ | OK | ? | - | - | DEAD | high |
| `mutator-dodging.audio.jump_sound` | Dodge jump sound (sv_dodging_sound) | OK | OK | - | - | OK | DEAD | medium |
| `mutator-dodging.anim.jump_action` | Dodge plays the jump animation (ANIMACTION_JUMP) | MISS | - | - | MISS | - | - | high |
| `mutator-dodging.lifecycle.reset` | Dodge state reset on spawn + observer (dodging_ResetPlayer) | ~ | OK | - | - | - | ~ | high |
| `mutator-dodging.clientselect.opt_in` | Client opt-in (sv_dodging_clientselect + cl_dodging + REPLICATE) | MISS | MISS | - | MISS | - | - | high |
| `mutator-dodging.frozen.dodge` | Frozen dodging (sv_dodging_frozen / _frozen_doubletap / horiz_force_frozen) | MISS | MISS | - | - | - | - | high |
...
| `doublejump.stat.per_player_doublejump` | Per-player DOUBLEJUMP stat via Physics_ClientOption | ~ | OK | OK | - | - | ~ | high |
...
| `dynamic_handicap.enable.predicate` | Mutator enable: g_dynamic_handicap AND not CTS/RACE | ~ | OK | - | - | - | live | high |
| `dynamic_handicap.triggers.recompute` | Recompute on roster/score change (4 functional hooks in Base) | ~ | - | ~ | - | - | live | high |
| `dynamic_handicap.apply.invalid_value_guard` | Handicap_SetForcedHandicap value<=0 error guard | ~ | - | - | - | - | live | high |
| `dynamic_handicap.present.handicap_level` | handicap_level int networked to client for scoreboard icon color | MISS | MISS | - | MISS | - | - | high |
| `dynamic_handicap.present.mutator_string` | BuildMutatorsString / BuildMutatorsPrettyString entries | MISS | MISS | - | MISS | - | - | medium |
...
| `mutator-globalforces.spread.hook` | Knockback spread on PlayerDamage_SplitHealthArmor: push every other in-range player by the damage force | ~ | OK | OK | - | - | live | high |
...
| `mutator-globalforces.advertise.mutatorstring` | Mutator-list advertisement (':GlobalForces' / ', Global forces') | MISS | MISS | - | - | - | - | high |

### `mutator-hook` (mutator) — 10 features

| id | name | L | V | T | P | A | live | conf |
|---|---|---|---|---|---|---|---|---|
| `mutator-hook.enable.predicate` | Enable predicate (string g_grappling_hook via expr_evaluate) | ~ | OK | - | - | - | live | high |
| `mutator-hook.onadd.free_reel` | MUTATOR_ONADD / ONROLLBACK_OR_REMOVE: free reeling when useammo off (WEP_HOOK.ammo_factor 0<->1) *(intended)* | OK | ~ | - | - | - | DEAD | high |
| `mutator-hook.spawn.assign_offhand` | PlayerSpawn: assign the hook as the player's offhand weapon | OK | - | OK | - | - | live | high |
| `mutator-hook.offhand.think_driver` | Offhand think: drive the Hook grapple each frame while +hook is held | ~ | - | ~ | - | - | DEAD | high |
| `mutator-hook.startitems.fuel` | SetStartItems: grant fuel + FuelRegen when useammo is on | OK | ~ | - | - | - | live | high |
| `mutator-hook.filteritem.hide_pickup` | FilterItem: suppress the WEP_HOOK world pickup | OK | - | - | - | - | live | high |
| `mutator-hook.info.mutator_string` | BuildMutatorsString / Pretty: list the mutator in server info / votescreen | MISS | MISS | - | MISS | - | - | high |
...
| `mutator-hook.precedence.blaster_override` | Precedence: offhand_blaster overrides grappling_hook when both enabled | ? | - | ? | - | - | ? | low |

### `mutator-instagib` (mutator) — 22 features

| id | name | L | V | T | P | A | live | conf |
|---|---|---|---|---|---|---|---|---|
| `mutator-instagib.enable.predicate` | Enable predicate + instagib item-list/flag setup (ONADD) | ~ | OK | - | - | - | live | high |
...
| `mutator-instagib.damage.vaporizer_lives` | Vaporizer hit subtracts an armor 'life', zero damage, lives-remaining centerprint | OK | OK | - | OK | ~ | live | high |
| `mutator-instagib.damage.blaster` | Blaster does no damage/force (keepdamage/keepforce/mirror cvars honored) | OK | OK | - | - | - | live | high |
| `mutator-instagib.damage.mirror_as_lives` | Mirror damage costs the attacker an armor 'life' instead of killing | OK | OK | - | OK | ~ | live | high |
| `mutator-instagib.damage.fall` | Fall damage never counted | OK | - | - | - | - | live | high |
| `mutator-instagib.damage.friendlyfire` | Friendly-fire (g_friendlyfire==0 + same team) damage nullification | MISS | MISS | - | - | - | - | high |
| `mutator-instagib.damage.contents` | Lava/slime/drown damage gated by g_instagib_damagedbycontents | MISS | MISS | - | - | - | - | high |
| `mutator-instagib.damage.friendlypush` | Vaporizer knockback on teammates gated by g_instagib_friendlypush | MISS | MISS | - | - | - | - | high |
...
| `mutator-instagib.regen.split_health_armor` | Armor never absorbs damage (PlayerDamage_SplitHealthArmor: take=damage, save=0) | MISS | MISS | - | - | - | - | high |
| `mutator-instagib.countdown.bleed` | No-ammo bleed-out countdown (1s cadence, 10/5 dmg, DEATH_NOAMMO, stop conditions) | ~ | OK | OK | - | - | live | high |
| `mutator-instagib.countdown.announce` | Countdown announcer + find-ammo centerprints (number ladder, TERMINATED, MULTI variant, DOWNGRADE, clear) | ~ | ~ | - | ~ | ~ | ~ | high |
| `mutator-instagib.spawn.fullbright` | Players glow fullbright on spawn (EF_FULLBRIGHT) | OK | OK | - | ? | - | live | medium |
| `mutator-instagib.items.filter` | FilterItem: convert/replace/remove map weapons, powerups, ammo, jetpacks + random-powerup deck | MISS | MISS | - | MISS | - | - | high |
| `mutator-instagib.items.touch` | ItemTouch: cells pickup full-heals to 100; ExtraLife grants armor lives | OK | OK | - | OK | OK | DEAD | high |
| `mutator-instagib.items.defs` | VaporizerCells / ExtraLife item definitions + spawnfuncs | MISS | MISS | MISS | MISS | MISS | - | high |
| `mutator-instagib.weapons.throw_arena_forbid` | Forbid Vaporizer throw; weapon-arena off; forbid random start weapons | ~ | - | - | - | - | ~ | high |
| `mutator-instagib.lifecycle.stop_countdown` | Stop the no-ammo countdown on MatchEnd and MakePlayerObserver | MISS | - | - | - | - | - | high |
| `mutator-instagib.misc.strings_monsters` | Mutator name/string tags; monster drop = vaporizer cells; Mage skin; random-items pick | MISS | MISS | - | MISS | - | - | medium |
...
| `mutator-invincibleproj.core.editprojectile_zero_health` | EditProjectile: zero a fired projectile's health so it can't be shot down | OK | OK | OK | - | - | ~ | high |
| `mutator-invincibleproj.string.machine` | BuildMutatorsString — append ':InvincibleProjectiles' to active-mutators token string | MISS | MISS | - | MISS | - | - | high |
| `mutator-invincibleproj.string.pretty` | BuildMutatorsPrettyString — append ', Invincible Projectiles' to display string | MISS | MISS | - | MISS | - | - | high |
...
| `mutator-itemstime.hud.enable_gate` | Panel enable gate (spectator/warmup/STAT(ITEMSTIME) visibility) | ~ | OK | - | ~ | - | live | high |
| `mutator-itemstime.net.itemstime_stat` | STAT(ITEMSTIME) client stat (= live sv_itemstime tier) | MISS | MISS | - | - | - | - | high |
...
| `mutator-kick_teamkiller.detect.gates` | Entry gates: teamplay only, not warmup, real (non-bot) attacker | ~ | - | - | - | - | live | high |
| `mutator-kick_teamkiller.detect.teamkill_score` | Read attacker's accumulated teamkill count (SP_TEAMKILLS) | OK | OK | - | - | - | live | high |
| `mutator-kick_teamkiller.detect.playtime` | Player playtime used as the rate denominator | ~ | ~ | ~ | - | - | live | high |
| `mutator-kick_teamkiller.detect.threshold` | Rate threshold: teamkills >= lower_limit AND teamkills >= rate*playtime/60 | OK | OK | ~ | - | - | live | high |
| `mutator-kick_teamkiller.action.punish` | Punishment switch: kick (1) / IP-ban (2) / play-ban+observe (default) | stub | stub | - | - | - | DEAD | high |
| `mutator-kick_teamkiller.notify.broadcast` | Broadcast + center-print notifications on punishment (severity-dependent) | ~ | ~ | - | ~ | - | ~ | high |

### `mutator-melee_only` (mutator) — 10 features

| id | name | L | V | T | P | A | live | conf |
|---|---|---|---|---|---|---|---|---|
| `melee_only.enable.predicate` | Enable predicate (g_melee_only and not instagib/overkill/arena) | ~ | ~ | - | - | - | live | high |
| `melee_only.loadout.start_items` | Start loadout: Shotgun only, zero shells (SetStartItems) | OK | OK | OK | - | - | live | medium |
...
| `melee_only.arena.force_off` | Force weapon arena off (SetWeaponArena -> 'off') | OK | OK | - | - | - | DEAD | high |
| `melee_only.weapons.forbid_random_start` | Forbid random start weapons (ForbidRandomStartWeapons -> true) | OK | OK | - | - | - | DEAD | high |
...
| `melee_only.ui.mutator_string_machine` | Machine mutator tag ':MeleeOnly' (BuildMutatorsString) | MISS | MISS | - | MISS | - | - | high |
| `melee_only.ui.mutator_string_pretty` | Pretty mutator label ', Melee only Arena' (BuildMutatorsPrettyString) | MISS | MISS | - | MISS | - | - | high |
...
| `mutator-midair.damage.multiplier` | Airborne damage multiplier (g_midair_damagemultiplier) | OK | ~ | ~ | - | - | live | high |
| `mutator-midair.damage.forcescale` | Airborne knockback-force scale (g_midair_damageforcescale) | OK | ~ | ~ | - | - | live | high |
| `mutator-midair.ground.shield_and_glow` | On-ground shield arming + EF_ADDITIVE|EF_FULLBRIGHT glow | OK | ~ | OK | OK | - | live | high |
| `mutator-midair.bot.disable_bunnyhop` | Disable bot bunnyhopping on spawn (bot_moveskill = 0) | MISS | MISS | - | - | - | - | high |
| `mutator-midair.meta.mutator_strings` | BuildMutatorsString / BuildMutatorsPrettyString (":midair" / ", Midair") | MISS | MISS | - | - | - | DEAD | high |
...
| `mutator-multijump.jump.rejump_grant` | Midair re-jump grant: ready-gate debounce + count/speed/maxspeed gates + add-vs-set z (PlayerJump hook) | ~ | ~ | OK | - | - | live | medium |
| `mutator-multijump.jump.client_gate` | Per-client cl_multijump opt-in/out/cap with g_multijump_client server default | MISS | MISS | - | MISS | - | - | high |
...
| `mutator-multijump.presentation.mutator_list_string` | Active-mutators serverinfo/scoreboard string (:multijump / , Multi jump) | MISS | MISS | - | MISS | - | - | medium |

### `mutator-nades` (mutator) — 21 features

| id | name | L | V | T | P | A | live | conf |
|---|---|---|---|---|---|---|---|---|
| `mutator-nades.enable.predicate` | Enable predicate + offhand assignment (g_nades) | OK | OK | - | - | - | live | high |
| `mutator-nades.throw.input_wire` | Throw input (offhand +hook release / weapon_drop double-press) | ~ | - | - | - | - | DEAD | high |
| `mutator-nades.prime.select` | nade_prime: type selection (strength / bonus / client-select / cvar) | OK | OK | OK | - | - | DEAD | high |
| `mutator-nades.throw.charge_force` | Charge-throw force ramp + spread cone | OK | OK | OK | - | - | DEAD | high |
| `mutator-nades.toss.projectile` | toss_nade: launch physics (size, newton-style, health, fuse) | OK | ~ | OK | - | - | DEAD | high |
| `mutator-nades.touch.bounce_pickup_detonate` | nade_touch: owner pass-through, pickup, bounce, impact detonate | OK | OK | OK | - | ~ | DEAD | high |
| `mutator-nades.damage.launch_destroy` | nade_damage: shoot-to-launch / shoot-to-destroy interactions | ~ | ~ | OK | - | - | DEAD | high |
| `mutator-nades.boom.dispatch` | nade_boom: type dispatch + destroyed->normal fallback | OK | - | OK | MISS | ~ | DEAD | high |
| `mutator-nades.boom.normal` | Normal nade explosion (RadiusDamage) | OK | OK | - | MISS | - | DEAD | high |
| `mutator-nades.boom.napalm` | Napalm: fireballs + fountain fire damage | ~ | ~ | OK | MISS | ~ | DEAD | high |
| `mutator-nades.boom.ice` | Ice: freeze field | ~ | OK | OK | MISS | OK | DEAD | high |
| `mutator-nades.boom.translocate` | Translocate: teleport thrower to detonation | ~ | OK | - | MISS | - | DEAD | medium |
| `mutator-nades.boom.spawn` | Spawn: relocate respawn point | OK | OK | - | MISS | - | ~ | high |
| `mutator-nades.boom.heal` | Heal: healing orb (friend heal / foe harm / armor) | OK | OK | OK | MISS | - | DEAD | high |
| `mutator-nades.boom.ammo` | Ammo: ammo orb (refill friend / drain foe) | OK | OK | OK | MISS | - | DEAD | high |
| `mutator-nades.boom.entrap_veil_darkness` | Entrap / Veil / Darkness orbs + fields | ~ | OK | OK | MISS | MISS | DEAD | high |
| `mutator-nades.boom.monster` | Pokenade: spawn monster | ~ | ~ | ~ | - | - | DEAD | medium |
| `mutator-nades.bonus.economy` | Bonus-nade economy (accrual / award / wipe) | ~ | ~ | OK | MISS | MISS | ~ | high |
| `mutator-nades.lifecycle.cleanup` | Held-nade/bonus cleanup + spectate copy + vehicle/death-drop toss | MISS | - | - | - | - | DEAD | high |
| `mutator-nades.damage.freezetag_revive` | Damage_Calculate: freezetag revive-nade | ~ | OK | OK | - | - | DEAD | high |
| `mutator-nades.presentation.client` | Client presentation: projectile/trail, orb model + 2D flash, darkness overlay, bonus ammo icon, charge ring | MISS | MISS | MISS | MISS | MISS | DEAD | high |
...
| `mutator-new_toys.replace.mapping` | Core->new-toy replacement mapping (nt_GetFullReplacement / nt_GetReplacement) | OK | OK | - | - | - | ~ | high |
| `mutator-new_toys.startitems.rearrange` | SetStartItems — rearrange the default start-weapon set through the replacement mapping | ~ | ~ | - | - | - | live | high |
| `mutator-new_toys.mapreplace.set_weaponreplace` | SetWeaponreplace — rewrite a map weapon_* entity's spawn (map "new_toys" key or auto mapping) | MISS | MISS | MISS | MISS | - | - | high |
| `mutator-new_toys.pickup.roflsound` | FilterItem — swap new-toy pickup sound to the 'New toys, new toys!' roflsound | MISS | MISS | - | MISS | MISS | - | high |
...
| id | name | L | V | T | P | A | live | conf |
|---|---|---|---|---|---|---|---|---|
| `mutator-nix.enable.gate` | Enable predicate (g_nix + arena-mutator exclusion) | ~ | OK | - | - | - | live | high |
| `mutator-nix.add.wrinit` | MUTATOR_ONADD: reset rotation globals + wr_init warm of choosable weapons | ~ | OK | - | - | - | live | high |
| `mutator-nix.remove.restore` | MUTATOR_ONREMOVE: restore start_ammo_* + start_weapons loadout | ~ | ~ | - | - | - | live | high |
...
| `mutator-nix.ammo.refill_trickle` | Per-weapon ammo wipe/refill + trickle | ~ | OK | OK | - | - | live | high |
| `mutator-nix.weaponset.force` | Force owned weapon set + switch each frame | ~ | OK | OK | - | - | live | medium |
...
| `mutator-nix.spawn.loadout` | PlayerSpawn loadout override + IT_UNLIMITED_SUPERWEAPONS | ~ | OK | - | - | - | live | high |
| `mutator-nix.forbid.randomstart` | ForbidRandomStartWeapons (suppress random start weapons) | OK | - | - | - | - | DEAD | high |
| `mutator-nix.entity.target_items` | OnEntityPreSpawn: delete target_items triggers | MISS | - | - | - | - | - | high |
| `mutator-nix.modname.strings` | BuildMutatorsString / BuildMutatorsPrettyString / SetModname (NIX label) | MISS | - | - | - | - | - | high |
...
| `offhand_blaster.fire.offhand_think` | Offhand fire: hold +hook to fire a Blaster shot without switching weapons | ~ | ~ | ~ | - | OK | DEAD | high |
| `offhand_blaster.fire.blaster_attack` | Blaster primary projectile fired by the offhand (damage/force/speed) | OK | OK | OK | OK | OK | DEAD | high |
| `offhand_blaster.precedence.over_hook` | Offhand blaster overrides the grappling hook offhand when both enabled | OK | - | - | - | - | live | high |
| `offhand_blaster.report.mutators_string` | Mutator appears in BuildMutatorsString / BuildMutatorsPrettyString | MISS | MISS | - | MISS | - | - | high |
...
| id | name | L | V | T | P | A | live | conf |
|---|---|---|---|---|---|---|---|---|
| `overkill.enable.predicate` | Mutator enable predicate (g_overkill + guards) | ~ | OK | - | - | - | live | high |
| `overkill.onadd.precache_and_itemblock` | MUTATOR_ONADD: precache ok_player models, set item mutator-block flags, build g_overkill_items list | MISS | MISS | - | MISS | - | - | high |
...
| `overkill.loot.drop_player` | ok_DropItem on player death (random loot, launched off corpse) | ~ | OK | ~ | MISS | - | live | high |
...
| `overkill.filter.items_and_powerup_replace` | FilterItem: block normal health/armor + replace Strength/Shield with HMG/RPC superweapons | MISS | MISS | MISS | MISS | - | - | high |
| `overkill.randomitems.inject_ok_items` | RandomItems_GetRandomItemClassName: weighted OK item/weapon pool | MISS | MISS | - | - | - | - | high |
...
| `overkill.forbid.random_start_weapons` | ForbidRandomStartWeapons -> true | stub | - | - | - | - | DEAD | high |
| `overkill.set_weapon_arena_off` | SetWeaponArena -> 'off' | stub | - | - | - | - | DEAD | high |
| `overkill.naming.mod_strings` | Mod-name strings: BuildMutatorsString ':OK', PrettyString ', Overkill', SetModname 'Overkill'; cl g_overkill cvar_settemp | MISS | MISS | - | MISS | - | - | high |
...
### `mutator-pinata` (mutator) — 7 features
...
| `mutator-pinata.death.throw_impulse` | Burst throw impulse — randomvec()*175 + '0 0 325' | OK | ~ | - | - | - | live | high |
...
| `mutator-pinata.report.mutators_string` | Active-mutators string hooks — BuildMutatorsString (':Pinata') + BuildMutatorsPrettyString (', Piñata') | MISS | MISS | - | - | - | - | high |
| `mutator-pinata.menu.metadata` | MENUQC metadata (describe text + create-game checkbox) | MISS | MISS | - | MISS | - | - | high |
...
| `powerups.speed.attack_rate` | Speed: weapon attack-rate (refire) multiplier | OK | OK | ~ | - | - | ~ | high |
| `powerups.invisibility.alpha` | Invisibility: player translucency while held | OK | OK | OK | ~ | - | live | high |
| `powerups.invisibility.stealth` | Invisibility: radar/monster/bot stealth | MISS | - | - | MISS | - | - | high |
| `powerups.glow.effects` | Strength/Shield player glow (EF_BLUE / EF_RED + EF_ADDITIVE + EF_FULLBRIGHT) | MISS | MISS | MISS | MISS | - | - | high |
| `powerups.strength.fire_sound` | Strength-fire sound (anti-spammed) on firing while Strength active | MISS | MISS | MISS | - | MISS | - | high |
| `powerups.notifications` | Pickup/powerdown notifications (center-print + broadcast) | MISS | - | - | MISS | - | - | high |
| `powerups.countdown_beep` | Powerdown countdown beep (play_countdown SND_POWEROFF) | MISS | - | MISS | - | MISS | - | high |
...
| `powerups.drop.ondeath_onuse` | Drop powerup on death / on +use (with countdown waypoint) | MISS | MISS | MISS | MISS | - | - | high |
| `powerups.obituary_mutator_strings` | Death-log item codes (S/I) + server-browser mutator strings | MISS | - | - | MISS | - | - | medium |
...
| id | name | L | V | T | P | A | live | conf |
|---|---|---|---|---|---|---|---|---|
| `random_gravity.enable.cvar_gate` | Enable gate — g_random_gravity cvar gating mutator registration + ONADD cvar_settemp | ~ | OK | OK | - | - | live | high |
...
| `random_gravity.roll.gamestart_gate` | Pre-match suppression gate (time < game_starttime) | MISS | - | MISS | - | - | - | high |
| `random_gravity.roll.round_gate` | Pre-round-start suppression gate (round active && !round started) | MISS | - | MISS | - | - | - | high |
...
| `random_gravity.advertise.mutator_string` | Mutator-list advertisement (BuildMutatorsString / BuildMutatorsPrettyString) | MISS | MISS | - | MISS | - | - | high |
...
| `random_items.engine.type_weighted_pick` | Type-weighted classname pick (RandomItems_GetRandomVanillaItemClassName) | ~ | ~ | - | - | - | DEAD | high |
| `random_items.engine.weapon_prob_cvar` | Per-weapon probability lookup + weapon classname construction | ~ | ~ | - | - | - | DEAD | high |
| `random_items.engine.item_prob_by_property` | Health/armor/resource/powerup classname pick (GetRandomItemClassNameWithProperty) | MISS | MISS | - | - | - | - | high |
| `random_items.engine.mod_injection_hook` | Mod-injection hook (RandomItems_GetRandomItemClassName MUTATOR_HOOKABLE; overkill/instagib override) | MISS | MISS | - | - | - | - | high |
| `random_items.map.filter_replace` | Map-item replacement on spawn (FilterItem -> RandomItems_ReplaceMapItem) | MISS | MISS | MISS | - | - | - | high |
| `random_items.map.item_touched_rerandom` | Re-randomize map item on respawn (ItemTouched -> replace + ScheduleRespawn + delete) | MISS | MISS | MISS | - | - | - | high |
| `random_items.loot.player_dies_count` | Loot count on death: floor(min + random()*max) items at corpse | OK | OK | OK | - | - | live | high |
| `random_items.loot.spawn_item` | Loot-item spawn (RandomItems_SpawnLootItem): classname + spread + lifetime | ~ | ~ | OK | - | - | DEAD | high |
| `random_items.spawn.recursion_guard_ok_flag` | Spawn-mechanics correctness: random_items_is_spawning recursion guard, ITEM_IS_LOOT skip, ok_item flag | MISS | MISS | - | - | - | - | high |
| `random_items.string.mutator_labels` | Active-mutators string hooks (BuildMutatorsString / BuildMutatorsPrettyString) | MISS | MISS | - | MISS | - | - | high |
...
| `mutator-rocketflying.allowrocketjumping.force_on` | AllowRocketJumping: force Devastator remote-jump self-boost on | MISS | MISS | - | - | - | - | high |
| `mutator-rocketflying.advertise.mutator_string` | BuildMutatorsString + BuildMutatorsPrettyString (advertise active mutator to clients) | MISS | - | - | MISS | - | - | high |
| `mutator-rocketflying.menu.describe` | Menu checkbox + description (MutatorRocketFlying.describe) | OK | OK | - | OK | - | live | medium |
...
| `mutator-rocketminsta.damage.zero_self_nade` | Damage_Calculate: zero Devastator self/nade damage | OK | OK | - | - | - | ~ | high |
| `mutator-rocketminsta.damage.zero_laser_self_round` | Damage_Calculate: zero Electro laser self / pre-round damage (g_rm_laser) *(intended)* | ~ | OK | - | - | - | ~ | high |
| `mutator-rocketminsta.kill.force_gib` | PlayerDies: force gib on Devastator/Electro kills (corpse damage = 1000) | OK | OK | - | - | - | ~ | high |
| `mutator-rocketminsta.primary.explosion` | Primary rail beam detonates a Devastator-style explosion at the endpoint | ~ | OK | OK | - | MISS | live | high |
| `mutator-rocketminsta.secondary.laser_barrage` | Secondary / out-of-cells primary: bouncing RM laser fan | ~ | ~ | ~ | MISS | ~ | live | high |
| `mutator-rocketminsta.laser.projectile_render` | RM laser projectile networking, model, trail, and team color | - | - | - | MISS | - | DEAD | high |
| `mutator-rocketminsta.laser.electrobitch` | Electrobitch achievement on flying-enemy laser timeout-explode | MISS | - | - | - | MISS | - | high |
| `mutator-rocketminsta.instagib.downgrade` | Out-of-ammo downgrade (no instagib death countdown) when g_rm + g_rm_laser | MISS | - | - | MISS | - | - | high |
...
| `running_guns.alpha.set_default_alpha` | SetDefaultAlpha override — player invisible (alpha -1), weapon visible (alpha +1) | OK | OK | - | MISS | - | DEAD | high |

### `mutator-sandbox` (mutator) — 15 features

| id | name | L | V | T | P | A | live | conf |
|---|---|---|---|---|---|---|---|---|
| `mutator-sandbox.core.registration` | Mutator activation via g_sandbox + onadd autoload | MISS | MISS | MISS | - | - | - | high |
| `mutator-sandbox.object.spawn` | object_spawn — create object entity from a model in front of player | MISS | MISS | MISS | MISS | - | - | high |
| `mutator-sandbox.object.think_grab` | Per-object think: grab-class assignment + owner UID resync + CSQC update | MISS | MISS | MISS | MISS | - | - | high |
| `mutator-sandbox.object.touch_material_fx` | Object touch: material impact particles + impact sounds (velocity-scaled) | MISS | MISS | MISS | MISS | MISS | - | high |
| `mutator-sandbox.object.edit_get` | Edit-target trace + ownership permission check | MISS | MISS | - | - | - | - | high |
| `mutator-sandbox.object.edit_properties` | object_edit — skin/alpha/color_main/color_glow/frame/scale/solidity/physics/force/material | MISS | MISS | MISS | MISS | - | - | high |
| `mutator-sandbox.object.scale` | Object scale clamp + mins/maxs resize | MISS | MISS | - | MISS | - | - | high |
| `mutator-sandbox.object.attach` | object_attach get/set/remove — child object attachment to tag/bone | MISS | MISS | - | MISS | - | - | high |
| `mutator-sandbox.object.remove` | object_remove — delete object + detach children + clear selections | MISS | - | - | MISS | - | - | high |
| `mutator-sandbox.object.duplicate` | object_duplicate copy/paste via clipboard cvar | MISS | MISS | MISS | - | - | - | high |
| `mutator-sandbox.object.claim_info` | object_claim + object_info object/mesh/attachments | MISS | - | - | MISS | - | - | high |
| `mutator-sandbox.storage.persist` | Per-map object storage: save/load + 5s auto-save + autoload at map start | MISS | MISS | MISS | - | - | - | high |
| `mutator-sandbox.drag.grab` | Drag/grab integration: carry objects with +button8 gated by .grab | MISS | MISS | MISS | MISS | - | - | high |
| `mutator-sandbox.hooks.gating` | readonly mode + Sandbox_DragAllowed/SaveAllowed/EditAllowed mutator hooks | MISS | MISS | - | - | - | - | high |
| `mutator-sandbox.menu.tools_dialog` | Sandbox Tools menu dialog (cvar inputs + command buttons) | OK | OK | - | OK | - | DEAD | high |

### `mutator-spawn_near_teammate` (mutator) — 8 features

| id | name | L | V | T | P | A | live | conf |
|---|---|---|---|---|---|---|---|---|
| `mutator-spawn_near_teammate.registration.cvar_gate` | Mutator registration + cvar gate (expr_evaluate g_spawn_near_teammate) | ~ | OK | - | - | - | live | high |
| `mutator-spawn_near_teammate.bias.spawn_score` | Spawn_Score bias: +200 near a living teammate, +100 same-team fallback | ~ | OK | - | - | - | live | high |
| `mutator-spawn_near_teammate.bias.lookat_facing` | Spawn facing: aim the spawned player at the chosen teammate | OK | OK | - | MISS | - | DEAD | high |
...
| `mutator-spawn_near_teammate.relocate.spot_search` | Relocate mode: 6-offset trace search for a clear floor beside the teammate | ~ | OK | - | - | - | live | high |
| `mutator-spawn_near_teammate.relocate.commit_closetodeath` | Relocate mode: pair-wise commit + closetodeath best-spot selection + cooldown | ~ | OK | OK | MISS | - | live | high |
...
| id | name | L | V | T | P | A | live | conf |
|---|---|---|---|---|---|---|---|---|
| `mutator-spawn_unique.enable.cvar` | Enable predicate via g_spawn_unique (expr_evaluate) | ~ | OK | - | - | - | live | high |
...
| `smneg.mutator_string` | BuildMutatorsString / BuildMutatorsPrettyString advertisement | MISS | MISS | - | MISS | - | - | high |
...
| `status_effects.framework.flags_enums` | ACTIVE/PERSISTENT flags + REMOVE_NORMAL/TIMEOUT/CLEAR enums | OK | OK | - | - | - | ~ | high |
...
| `status_effects.framework.remove` | StatusEffects_remove (zero timer+flags, removal sound if NORMAL & active & !persistent) | ~ | - | - | - | MISS | live | high |
| `status_effects.framework.tick` | StatusEffects_tick — per-frame: PERSISTENT recompute, timeout removal, per-effect m_tick | ~ | ~ | ~ | MISS | MISS | live | high |
| `status_effects.framework.gettime` | StatusEffects_gettime (timer read with still-active-this-frame clamp) | ~ | OK | ~ | - | - | live | medium |
| `status_effects.framework.persistent` | m_persistent flag (passive grant: no timeout) + SetPersistent + per-frame recompute | stub | - | - | - | - | DEAD | high |
| `status_effects.framework.removeall_lifecycle` | removeall/clearall on death, disconnect, observer, map reset, PutClientInServer; SpectateCopy alias | MISS | - | - | - | - | - | medium |
...
| `status_effects.burning` | Burning effect (EF_FLAME, Fire_AddDamage/ApplyDamage, water/frozen extinguish, lava persistence, removal sound) | ~ | ~ | ~ | ~ | MISS | live | high |
...
| `status_effects.spawnshield_stunned_superweapon` | SpawnShield (EF_ADDITIVE|FULLBRIGHT), Stunned (EF_SHOCK), Superweapon (persistence + countdown sound) | ~ | OK | OK | MISS | MISS | ~ | high |

### `mutator-superspec` (mutator) — 11 features

| id | name | L | V | T | P | A | live | conf |
|---|---|---|---|---|---|---|---|---|
| `superspec.enable.predicate` | Enable predicate + registration (expr_evaluate(g_superspectate)) | MISS | MISS | - | - | - | - | high |
| `superspec.state.flag_bitfields` | Per-client option state (.autospec_flags, .superspec_flags, .superspec_itemfilter) | MISS | MISS | - | - | - | - | high |
| `superspec.spectate.transfer` | Spectate transfer helper (superspec_Spectate wrapping Spectate) | MISS | - | - | - | - | - | high |
| `superspec.persistence.options_file` | Per-client options persistence (load on connect / save on disconnect, crypto_idfp-keyed) | MISS | MISS | MISS | - | - | - | high |
| `superspec.notify.missing_uid` | Missing-UID notification (delayed-hello think at time+5 -> INFO_SUPERSPEC_MISSING_UID) | MISS | OK | MISS | stub | - | DEAD | high |
| `superspec.msg.helper` | Spectator message helper (superspec_msg: sprint + conditional centerprint by silent/verbose/spamlevel) | MISS | MISS | - | MISS | - | - | high |
| `superspec.itemfilter.match` | Item-message classname filter (superspec_filteritem; empty = all) | MISS | MISS | - | - | - | - | high |
| `superspec.itemtouch.autospec_and_msg` | ItemTouch hook: pickup messages + auto-spectate on powerup/mega/flag/item-msg | MISS | MISS | - | MISS | - | - | high |
| `superspec.playerdies.followkiller` | PlayerDies hook: followkiller auto-spectate the attacker | MISS | MISS | - | MISS | - | - | high |
| `superspec.commands.parse` | Spectator console commands (superspec / autospec / superspec_itemfilter / followpowerup / followstrength / followshield) | MISS | MISS | - | MISS | - | - | high |
| `superspec.ui.mutator_strings` | Mutator string tags (:SS machine tag + ', Super Spectators' pretty label) | MISS | MISS | - | MISS | - | - | high |
...
| `touchexplode.blast.radiusdamage` | Midpoint explosion + RadiusDamage | OK | ~ | - | - | - | live | high |
| `touchexplode.blast.deathtype` | DEATH_TOUCHEXPLODE death type / obituary | MISS | - | - | MISS | - | DEAD | high |
| `touchexplode.blast.presentation` | Impact sound + explosion_small particle | ~ | - | - | MISS | ~ | ~ | high |
...
| id | name | L | V | T | P | A | live | conf |
|---|---|---|---|---|---|---|---|---|
| `mutator-vampire.enable.gate` | Enable predicate (g_vampire + instagib exclusion) | ~ | OK | - | - | - | live | high |
| `mutator-vampire.heal.on_damage` | Heal attacker by damage dealt (PlayerDamage_SplitHealthArmor hook) | ~ | ~ | ~ | - | - | live | high |
...
| `mutator-vampire.report.mutator_strings` | Mutator-list strings + menu description (':Vampire' / ', Vampire' / MENUQC describe) | - | - | - | MISS | - | DEAD | high |
...
| `mutator-vampirehook.latch.aiment_follow` | Latched hook follows its toucher (sets .aiment) — the precondition for the drain | MISS | - | - | - | - | - | high |
| `mutator-vampirehook.drain.engine` | GrappleHookThink drain/heal/self-drain on the hooked player | ~ | ~ | OK | - | - | DEAD | high |
| `mutator-vampirehook.drain.heal_indirection` | Heal via event_heal/PlayerHeal vs direct GiveResourceWithLimit | ~ | ~ | - | - | - | DEAD | high |
...
| `mutator-walljump.fx.smokering` | Smoke-ring particle at the wall contact point | MISS | MISS | - | MISS | - | DEAD | high |
| `mutator-walljump.fx.sound` | Wall-jump jump voice (PlayerSound playersound_jump) | ~ | MISS | OK | stub | stub | ~ | high |
| `mutator-walljump.fx.anim_and_oldvel` | Jump animation action + post-impulse oldvelocity stash | ~ | - | - | MISS | - | ~ | high |

### `mutator-waypoints` (mutator) — 13 features

| id | name | L | V | T | P | A | live | conf |
|---|---|---|---|---|---|---|---|---|
| `waypoints.registry.defs` | Waypoint-kind registry (WP_* defs: text/icon/color/blink) | ~ | ~ | - | ~ | - | ~ | high |
| `waypoints.server.manager_api` | Server WaypointSprite_* spawn/update/kill API + manager | ~ | ~ | OK | - | - | DEAD | high |
...
| `waypoints.deploy.personal_here_danger` | Player-deployed pings (waypoint_personal/here/danger impulses) | MISS | MISS | MISS | MISS | - | DEAD | high |
| `waypoints.deploy.helpme` | Team HELP-ME attach + ping (waypoint_here_follow) | MISS | MISS | MISS | stub | - | DEAD | high |
| `waypoints.visibility.rules` | Per-peer visibility filter (SPRITERULE_DEFAULT/TEAMPLAY/SPECTATOR) | ~ | - | - | - | - | live | high |
...
| `waypoints.client.draw` | 3D in-world sprite draw (icon/text + arrow + project) *(intended)* | ~ | ~ | OK | ~ | - | live | high |
| `waypoints.client.fades` | Distance / edge / crosshair / lifetime fades + blink | ~ | ~ | ~ | ~ | - | live | high |
| `waypoints.client.cvars_inert` | Client tuning cvars (g_waypointsprite_*, cl_hidewaypoints) wiring | MISS | stub | - | MISS | - | DEAD | high |
...
| `mutator-weaponarena_random.playerspawn` | PlayerSpawn: replace owned set with random N-subset (keep blaster) | OK | ~ | OK | - | - | live | high |
| `mutator-weaponarena_random.givefragsforkill` | GiveFragsForKill: swap culprit weapon for a new random one | ~ | ~ | ~ | - | - | live | high |
| `mutator-weaponarena_random.w_randomweapons` | W_RandomWeapons: uniform pick without replacement *(intended)* | OK | OK | - | - | - | live | high |
| `mutator-weaponarena_random.arena_weaponset_dep` | Base weapon-arena loadout (g_weaponarena -> start_weapons) — dependency | MISS | MISS | - | - | - | - | high |
...
| `net-entity-state.wepent.charges_clip_heat` | wepent charge/clip/heat HUD fields (vortex/oknex charge+pool, clip_load/size, hagar_load, minelayer_mines, arc_heat) | MISS | MISS | MISS | stub | - | DEAD | medium |
...
| `fx-deathtypes.message.special_nade_misc` | NADE-family + cheat/camp/rot/shooting_star/touchexplode special-death messages | ~ | MISS | - | ~ | - | ~ | high |
...
| `fx-deathtypes.message.mapper_custom` | HURTTRIGGER mapper message (msg_from_ent / DEATH_*_VOID_ENT) + DEATH_CUSTOM (deathmessage) | MISS | - | - | MISS | - | DEAD | medium |
...
### `fx-notifications` (notification) — 14 features

| id | name | L | V | T | P | A | live | conf |
|---|---|---|---|---|---|---|---|---|
| `fx-notifications.registry.types` | Notification registry + 5 message types (MSG_ANNCE/INFO/CENTER/MULTI/CHOICE) | OK | OK | - | - | - | live | medium |
...
| `fx-notifications.center.render` | MSG_CENTER -> centerprint (cpid replace/kill, ^COUNT countdown) | OK | OK | ~ | OK | - | live | high |
| `fx-notifications.center.durcnt` | Centerprint durcnt (duration/count) + item_centerprinttime | MISS | MISS | MISS | ~ | - | DEAD | high |
...
| `fx-notifications.gentle.variants` | Gentle-mode message-variant selection (normal_or_gentle / cl_gentle) | ~ | OK | - | ~ | - | DEAD | high |
| `fx-notifications.net.kill` | Kill_Notification / MSG_CENTER_KILL (server clears a centerprint group) | MISS | - | - | MISS | - | - | high |
...
| `physics-movetypes.toss.bounce` | Bounce/BounceMissile restitution + bouncestop settle (grenades, casings, balls) | ~ | ~ | OK | - | - | live | high |
| `physics-movetypes.step.physics` | MOVETYPE_STEP integrator (monster bodies) | ~ | ~ | OK | - | ~ | live | high |
| `physics-movetypes.walk.stepmove` | WalkMove slide + explicit stair up/down stepping | ~ | ~ | OK | - | - | live | high |
...
| `physics-movetypes.checkwater` | CheckWater / CheckWaterTransition (waterlevel + transition cue) | ~ | ~ | OK | - | ~ | live | high |
...
| `physics-player.air.warsowbunny` | Warsow-bunny air accel (PM_AirAccelerate) | OK | OK | OK | - | - | DEAD | high |
...
| `physics-player.movement_sounds` | Footsteps + landing sounds (PM_Footsteps / PM_check_hitground) | ~ | ~ | ~ | - | ~ | live | high |
...
| `scoring.winningcondition.remaining_frags_announce` | Remaining-frags announcer (Scores_CountFragsRemaining -> REMAINING_FRAG_{1,2,3}) | MISS | MISS | MISS | - | MISS | - | high |
| `scoring.lifecycle.clear` | Score clearing (PlayerScore_Clear via g_score_resetonjoin / Score_ClearAll) | ~ | OK | - | - | - | ~ | high |
...
| `scoring.helper.float2int_decimal_carry` | Fractional-score accumulator (_GameRules_scoring_add_float2int decimal carry) | ~ | ~ | ~ | - | - | DEAD | high |
| `scoring.lifecycle.game_stopped` | game_stopped score clamp (drop score additions post-match/warmup-end) | ~ | OK | ~ | - | - | ~ | medium |
...
| `sv-anticheat.report.eventlog` | anticheat_report_to_eventlog (:anticheat: verdict lines on disconnect) | OK | OK | - | - | - | DEAD | high |
...
| `sv-anticheat.report.display_verdict` | anticheat_display N/Y/- verdict formatting + ANTICHEATS table | OK | OK | - | OK | - | ~ | high |
| `sv-anticheat.spectate.evade_angle_copy` | anticheat_spectatecopy (spectator body follows spectatee evade angle) | OK | OK | - | stub | - | DEAD | high |
...
| `sv-antilag.setupshot.trueaim` | W_SetupShot trueaim + shotorg traces are antilagged (g_antilag==2) | ~ | OK | OK | - | - | DEAD | high |
...
| `sv-antilag.arc_beam` | Arc beam lag-compensated trace + antilag_takebackavgvelocity | ~ | OK | OK | - | - | - | high |
...
| `sv-campaign.preinit.gametype_switch` | MapInfo_SwitchGameType + Campaign_Invalid revalidation | ~ | - | - | - | - | live | high |
...
| `sv-campaign.mapentity.levelwarp` | target_levelwarp / target_changelevel campaign win-credit (map-triggered) | stub | - | - | - | - | DEAD | high |
| `sv-campaign.mapentity.gametype_switch` | target_changelevel next-map gametype switch (MapInfo_SwitchGameType on .gametype) | stub | - | - | - | - | DEAD | high |
| `sv-campaign.forceteam` | g_campaign_forceteam: force the player onto a given team in campaign | MISS | OK | - | - | - | DEAD | high |
| `sv-campaign.welcome.levelnum` | Campaign level number in the welcome/info message (Campaign_GetLevelNum) | MISS | - | - | MISS | - | DEAD | medium |
...
| `sv-chat.voice.say_coupling` | VoiceMessage text routed through Say (flood-throttle + chat display + fake/real sound gating) | MISS | MISS | MISS | MISS | ~ | DEAD | high |
...
| id | name | L | V | T | P | A | live | conf |
|---|---|---|---|---|---|---|---|---|
| `sv-cheats.gating.cheats_allowed` | CheatsAllowed — sv_cheats snapshot + dead/observer/maycheat gating | ~ | OK | OK | - | - | live | high |
...
| `sv-cheats.cmd.usetarget` | cmd usetarget — fire a named target (SUB_UseTargets) | ~ | OK | OK | - | - | DEAD | high |
| `sv-cheats.cmd.killtarget` | cmd killtarget — remove a named target (SUB_UseTargets killtarget) | ~ | OK | OK | - | - | DEAD | high |
| `sv-cheats.impulse.give_all` | Cheat impulse GIVE_ALL (99) — give all | stub | OK | - | - | - | DEAD | high |
...
| `sv-client-lifecycle.join.join_player` | Join: observer -> live player | ~ | OK | OK | MISS | MISS | live | high |
...
| `sv-client-lifecycle.observer.put_observer_in_server` | PutObserverInServer: demote to free-fly observer | ~ | ~ | OK | ~ | - | ~ | medium |
...
| `sv-client-lifecycle.frame.player_regen` | player_regen: health/armor/fuel regen + rot | ~ | OK | OK | - | - | live | high |
...
| id | name | L | V | T | P | A | live | conf |
|---|---|---|---|---|---|---|---|---|
| `sv-clientkill.command.kill` | `kill` console command → suicide | ~ | - | ~ | - | - | live | high |
| `sv-clientkill.countdown.delay` | g_balance_kill_delay countdown timer before death | MISS | MISS | MISS | - | - | - | high |
...
| `sv-clientkill.announcer.number` | Spoken kill countdown announcer (ANNCE_NUM_KILL_n) | MISS | - | MISS | stub | MISS | DEAD | high |
| `sv-clientkill.centerprint.teamchange` | Center-print 'Suicide/Changing to TEAM/Spectating in N' | MISS | - | MISS | stub | - | DEAD | high |
...
| `sv-commands-votes.vote.call` | vote call — open a whitelisted call-vote (guard chain + caller auto-yes + cooldown) | ~ | ~ | OK | ~ | MISS | live | high |
| `sv-commands-votes.vote.parse_whitelist` | VoteCommand_parse — whitelist match, nasty-char sanitize, command rewriting | ~ | ~ | - | - | - | live | high |
...
| `sv-commands-votes.timeout.state_machine` | timeout / timein — LEADTIME→ACTIVE→resume pause with per-player allowance | OK | ~ | ~ | MISS | MISS | live | high |
...
| `sv-commands-votes.common.cointoss` | cointoss — random coin flip broadcast | ~ | ~ | - | OK | - | live | high |
...
| `sv-handicap.total.forced_times_voluntary` | Total handicap = forced x voluntary, per direction | ~ | ~ | - | - | - | live | high |
| `sv-handicap.voluntary.cl_handicap_cvars` | Voluntary handicap from cl_handicap / cl_handicap_damage_given/taken | MISS | MISS | MISS | - | - | - | high |
...
| `sv-handicap.xonstat.avg_sums` | Per-player damage-weighted handicap avg for the game report | stub | MISS | MISS | - | - | DEAD | high |
...
| id | name | L | V | T | P | A | live | conf |
|---|---|---|---|---|---|---|---|---|
| `sv-impulse.dispatch.commands_gate` | ImpulseCommands dispatch + match-state gating | ~ | - | OK | - | - | live | high |
...
| `sv-impulse.action.reload` | weapon_reload (impulse 20) | ~ | - | OK | - | ? | live | medium |
...
| `sv-impulse.cheat.impulses` | Cheat impulses (give-all 99, clone/speedrun/teleport/eliminate 140-148) | ~ | - | - | - | - | DEAD | high |
...
| `sv-intermission.timer.exittime` | Intermission exit timer (intermission_exittime + sv_mapchange_delay, -1 with no players) | ~ | ~ | ~ | - | - | live | high |
| `sv-intermission.timer.input_early_exit` | Player input skips the scoreboard (press fire/jump after the hold) | stub | - | stub | MISS | - | DEAD | high |
...
| `sv-intermission.mapvote.client_ui` | Client map-vote ballot UI (MapVote_Draw) | OK | OK | - | stub | - | DEAD | high |
...
| `sv-ipban.softban.playban` | Playban (g_playban_list): force spectate + minigame removal + connect re-apply | ~ | ~ | - | - | - | ~ | high |
| `sv-ipban.softban.playban.join_gate` | Playban join-attempt enforcement: a play-banned client cannot (re)join the game | MISS | - | - | MISS | - | - | high |
...
| id | name | L | V | T | P | A | live | conf |
|---|---|---|---|---|---|---|---|---|
| `sv-mapvoting.lifecycle.think_loop` | Vote lifecycle / think loop (start, throttle, winner delay) | ~ | ~ | ~ | - | - | live | high |
| `sv-mapvoting.ballot.build` | Build the ballot from rotation + suggestions + abstain | ~ | ~ | - | - | - | live | high |
...
| `sv-mapvoting.cast.vote` | Cast a vote (impulse -> .mapvote) | stub | - | - | - | - | DEAD | high |
| `sv-mapvoting.cast.abstain` | Abstain (Don't care) option | stub | OK | - | - | - | DEAD | high |
| `sv-mapvoting.decide.tally_rank` | Tally votes + rank candidates | ~ | - | - | - | - | ~ | high |
| `sv-mapvoting.decide.early_finish` | Early finish: timeout / leader unbeatable / all voted | ~ | OK | OK | - | - | ~ | high |
| `sv-mapvoting.decide.reduce` | Ballot reduce / keep-two (mid-vote option pruning) | MISS | MISS | MISS | MISS | - | - | high |
| `sv-mapvoting.finish.winner` | Finish + pick winner + apply map change | ~ | - | ~ | - | - | live | high |
| `sv-mapvoting.gametype_vote` | Gametype vote (pre-map gametype ballot + switch) | MISS | ~ | MISS | MISS | - | - | high |
| `sv-mapvoting.suggestions` | Player map suggestions (suggestmap) | ~ | ~ | - | - | - | ~ | high |
| `sv-mapvoting.net.sync` | Vote state networking (ENT_CLIENT_MAPVOTE + screenshot transfer) | MISS | - | - | MISS | - | - | high |
| `sv-mapvoting.client.draw` | Client vote-screen panel (grid, thumbnails, counts, winner reveal) | OK | ~ | MISS | OK | - | DEAD | high |
...
| `sv-spawnpoints.select.spawnpoint_targ` | target_spawnpoint forced-spawn redirection | stub | - | - | - | - | DEAD | high |
| `sv-spawnpoints.relocate.move_out_of_solid` | relocate_spawnpoint move-out-of-solid | ~ | MISS | - | - | - | DEAD | high |
...
| `sv-spawnpoints.fx.spawnpoint_idle_glow` | Idle spawn-point particle glow (Spawn_Draw) *(intended)* | OK | ~ | OK | ~ | - | live | medium |
...
| `sv-teamplay.join.skill_weighting` | Inverse-variance skill-weighted balance (g_balance_teams_skill) | ~ | stub | - | - | - | ~ | high |
| `sv-teamplay.balance.autobalance_bots` | Bot autobalance (move lowest-scoring bot largest->smallest) | ~ | ~ | ~ | - | - | live | high |
| `sv-teamplay.balance.prevent_imbalance` | Block switching to a stronger/larger team mid-match | MISS | ~ | - | - | - | - | high |
| `sv-teamplay.forced.determine_team` | Forced teams (g_forced_team_*, otherwise, campaign forceteam) | MISS | MISS | - | - | - | - | high |
...
| `sv-teamplay.nagger.team_nagger` | Unbalanced-teams nag + warmup hold (sv_teamnagger) | MISS | MISS | - | MISS | - | - | high |
| `sv-teamplay.bot_vs_human.team_split` | bot_vs_human team partitioning (bots vs humans on separate teams) | ~ | OK | - | - | - | ~ | high |
...
| `sv-teamplay.lock.lockonrestart` | Auto-lock teams on ready-restart (teamplay_lockonrestart) | MISS | MISS | - | - | - | - | high |
| `sv-teamplay.bot.bot_forced_team` | Bot forced team (bot_forced_team from bot config/connect) | MISS | - | - | - | - | - | high |
...
| `sv-world-rules.warmup.stage` | Warmup stage entry + limit resolution | ~ | ~ | OK | - | - | live | high |
| `sv-world-rules.warmup.serverflags` | readlevelcvars serverflags (fullbright / pickuptimer) | MISS | MISS | - | MISS | - | - | high |
| `sv-world-rules.warmup.ready_count` | ReadyCount ready-up majority + countdown abort | ~ | ~ | OK | MISS | MISS | live | high |
| `sv-world-rules.warmup.ready_restart` | ReadyRestart / ReadyRestart_force match-restart flow | ~ | ~ | ~ | - | - | live | high |
| `sv-world-rules.warmup.reset_map` | reset_map: full map/player reset on restart | ~ | OK | OK | - | - | live | high |
| `sv-world-rules.checkrules.cascade` | CheckRules_World per-frame win cascade | ~ | OK | OK | - | MISS | live | high |
...
| `sv-world-rules.misc.start_delay` | g_start_delay pre-match join window | MISS | MISS | MISS | - | - | - | high |
...
| `fx-sounds.voice.globalsound_dispatch` | _GlobalSound VOICETYPE routing (recipients + taunt/gentle gates) | ~ | OK | - | ~ | MISS | live | high |
| `fx-sounds.voice.live_body_callers` | PlayerSound/GlobalSound call sites (footstep/fall/pain/death/jump) | ~ | ~ | OK | ~ | ~ | live | high |
| `fx-sounds.voice.persounds_manifest` | LoadPlayerSounds .sounds manifest parse + per-model/skin reload | MISS | MISS | - | - | MISS | DEAD | high |
...
| `turret-ewheel.setup.tr_setup` | tr_setup: SlideBox/Step creature, select flags, ammo flags, home pose | OK | ~ | - | - | - | live | high |
| `turret-ewheel.spawn.liveness` | Map spawnfunc wiring + per-frame think (turret_ewheel placed on map) | OK | OK | OK | - | - | live | high |
| `turret-ewheel.combat.brain` | Acquire/aim/fire combat brain (shared turret_think framework) | OK | ~ | OK | - | - | live | medium |
| `turret-ewheel.drive.enemy` | tr_think locomotion: chase/kite/hold toward enemy + body yaw | ~ | ~ | OK | - | - | live | high |
| `turret-ewheel.drive.path` | Waypoint path following (ewheel_move_path / ewheel_findtarget) | MISS | MISS | MISS | - | - | - | high |
| `turret-ewheel.drive.idle` | ewheel_move_idle: brake to a stop + idle frame | OK | ~ | OK | MISS | - | live | high |
| `turret-ewheel.weapon.fire` | EWheelAttack: fast blaster bolt volley (2 shots, near-hitscan) | OK | ~ | OK | MISS | ~ | live | high |
| `turret-ewheel.damage.lifecycle` | Damage gating, head-shake, MOVE-shove, death + respawn | OK | ~ | ~ | - | ? | live | high |
| `turret-ewheel.head.track` | Head rotation: track type + aim clamps | ~ | ~ | OK | - | - | live | high |
...
| id | name | L | V | T | P | A | live | conf |
|---|---|---|---|---|---|---|---|---|
| `turret-flac.identity.spawn` | FLAC turret identity, hitbox, model, health, map spawn | OK | ~ | - | MISS | - | live | high |
...
| `turret-flac.target.scoring_biases` | Target-selection scoring biases (range/angle/missile/player/same) | OK | ~ | - | - | - | live | high |
| `turret-flac.aim.lead_compensate` | Lead aim + shot-traveltime compensation (intercept a fast missile) | ~ | ~ | OK | - | - | live | high |
| `turret-flac.aim.track_motor` | Head track motor (fluid-inertia) + per-axis aim limits | OK | ~ | OK | - | - | live | high |
| `turret-flac.fire.flak_shell` | Flak shell fire: fast splash projectile + timed air-burst fuse | OK | ~ | ~ | MISS | OK | live | high |
| `turret-flac.lifecycle.respawn` | Death + respawn timer (and the port's extra death blast) | ~ | ~ | ~ | - | - | live | high |
...
| `turret-framework.brain.think` | Per-frame brain: ammo regen + scan/aim/track/fire driver (turret_think) | ~ | ~ | OK | - | - | live | high |
| `turret-framework.acquire.target` | Target acquisition: radius scan + validate cascade + bias scoring | OK | ~ | OK | - | - | live | high |
...
| `turret-framework.lifecycle.use_damage` | Activation + damage gate (turret_use / turret_damage / turret_heal) | ~ | - | - | - | - | DEAD | high |
...
| `turret-hellion.setup.tr_setup` | tr_setup: aim/select/firecheck/ammo flags, fluid-inertia tracker | ~ | ~ | OK | - | - | live | high |
| `turret-hellion.spawn.liveness` | Map spawnfunc wiring + per-frame think (turret_hellion placed on map) | OK | OK | OK | - | - | live | high |
| `turret-hellion.combat.brain` | Acquire/aim/track/fire combat brain (AIM_SIMPLE, shared framework) | OK | ~ | OK | - | - | live | high |
| `turret-hellion.weapon.launch` | HellionAttack: launch a heat-seeking missile (2-shot volley) | OK | ~ | OK | MISS | OK | live | high |
| `turret-hellion.missile.guidance` | turret_hellion_missile_think: heat-seeking lead-predict + accelerate | OK | ~ | OK | - | - | live | high |
| `turret-hellion.missile.detonate` | Missile detonation: touch / proximity / fuel-out / shot-down -> radius damage | OK | ~ | OK | - | - | live | high |
| `turret-hellion.anim.headspin` | Launcher head-spin animation (tr_think frame 1..6 -> 0) | MISS | MISS | MISS | MISS | - | - | high |
| `turret-hellion.damage.lifecycle` | Damage gating, retaliation, death + respawn | ~ | ~ | ~ | - | ? | live | high |
...
| `turret-hk.combat.brain` | Acquire/aim/track/fire combat brain (shared turret framework) | OK | ~ | OK | - | - | live | high |
...
| `turret-hk.damage.lifecycle` | Damage gating, retaliation, death + respawn | OK | ~ | ~ | - | ? | live | high |
| `turret-hk.anim.head` | tr_think head-frame animation (launcher cycle 0..5) | MISS | MISS | MISS | MISS | - | - | high |
| `turret-hk.head.track` | Head rotation: track type + aim clamps | OK | ~ | OK | - | - | live | high |
...
| `turret-machinegun.setup.flags` | tr_setup behaviour flags (target/aim/ammo/damage/turret) | ~ | ~ | - | - | - | ~ | high |
| `turret-machinegun.tunables.balance` | Per-unit balance tunables (g_turrets_unit_machinegun_*) | OK | OK | OK | - | - | live | high |
| `turret-machinegun.think.loop` | Per-frame think (ammo regen + acquire/aim/track/fire driver) | OK | ~ | OK | - | - | live | high |
...
| `turret-machinegun.aim.lead` | turret_aim_generic lead + shot-traveltime compensation | OK | OK | OK | - | - | live | medium |
...
| `turret-machinegun.weapon.firebullet` | wr_think fireBullet (hitscan bullet + spread + force) | OK | OK | - | MISS | ~ | live | high |
| `turret-machinegun.lifecycle.use_team` | turret_use: adopt activator team, set active | OK | OK | - | - | - | live | medium |
| `turret-machinegun.lifecycle.damage` | turret_damage gate: inactive-immunity, friendly-fire, headshake | ~ | OK | - | MISS | - | DEAD | high |
| `turret-machinegun.lifecycle.die_respawn` | turret_die / turret_respawn (+ death FX, gibs) | ~ | ~ | OK | MISS | MISS | live | high |
...
| `turret-mlrs.combat.brain` | Acquire/aim/lead/track/fire combat brain incl. VOLLYALWAYS burst completion + target scoring | ~ | ~ | OK | - | - | live | high |
| `turret-mlrs.head.track` | Head rotation: FluidInertia track + aim clamps | OK | ~ | OK | - | - | live | high |
| `turret-mlrs.anim.ammogauge` | tr_think head ammo-gauge frame (0 full .. 6 empty by remaining ammo) | MISS | MISS | MISS | MISS | - | - | high |
| `turret-mlrs.weapon.fire` | MLRSTurretAttack: 6-rocket splash volley (unguided, shootable, travel-time fuse) | OK | ~ | ~ | MISS | OK | live | high |
...
| `turret-phaser.audio.beam_sound` | Phaser beam sound (start + 2s re-trigger + silence-on-end) and impact cue | ~ | MISS | MISS | - | MISS | DEAD | high |
...
| `turret-phaser.lifecycle.respawn_time` | Death blast + respawn timer | OK | ~ | ~ | - | - | live | high |
...
| `turret-plasma.balance.cvars` | Balance constants (damage/refire/range/ammo/aim) from g_turrets_unit_plasma_* | OK | ~ | - | - | - | live | high |
| `turret-plasma.setup.flags` | tr_setup flag configuration (ammo/damage/firecheck/aim flags) | ~ | ~ | - | - | - | live | high |
| `turret-plasma.think.pipeline` | Per-frame think: ammo regen, acquire/scan delays, aim, track, fire gate | OK | ~ | ~ | - | - | live | high |
| `turret-plasma.target.select_score` | Target validation + bias-weighted scoring + selection | OK | OK | - | - | - | live | high |
| `turret-plasma.aim.lead_splash` | Aim prediction: lead + shot-traveltime compensate + ground splash | OK | ~ | OK | - | - | live | high |
| `turret-plasma.track.fluid_inertia` | Head track motor (fluid-inertia) with per-axis pitch/rot clamps | OK | ~ | OK | MISS | - | live | high |
...
| `turret-plasma.attack.instagib_railgun` | tr_attack instagib override: instant railgun beam | OK | ~ | OK | MISS | ~ | live | high |
| `turret-plasma.headspin.frame_anim` | Head spin frame animation after each shot (tr_think frame 1->5) | MISS | MISS | MISS | MISS | - | - | high |
| `turret-plasma.damage.gate_retaliate` | turret_damage: inactive invuln, friendly-fire scale, headshake, retaliate | ~ | ~ | - | - | - | DEAD | high |
| `turret-plasma.death.die_respawn` | Death + respawn (turret_die / turret_hide / turret_respawn) | ~ | ~ | OK | MISS | MISS | live | high |
...
| `turret-plasma_dual.attack.plasma_ball` | tr_attack non-instagib: electro-style splash plasma projectile | OK | ~ | OK | MISS | OK | live | high |
| `turret-plasma_dual.attack.instagib_rail` | tr_attack instagib branch: instant 800-damage railgun beam | OK | OK | OK | MISS | ~ | live | medium |
| `turret-plasma_dual.values.engagement_envelope` | Engagement envelope: refire, ranges, ammo, aim/track tunables | OK | ~ | OK | - | - | live | high |
| `turret-plasma_dual.target.scoring_biases` | Target scoring biases (rangebias/samebias/anglebias/playerbias/missilebias) | OK | ~ | - | - | - | live | high |
| `turret-plasma_dual.aim.lead_splash_predict` | Aiming: lead + shot-time compensation + z-predict + splash (aim at feet) | OK | OK | OK | - | - | live | medium |
| `turret-plasma_dual.track.head_motor` | Head tracking: FLUIDINERTIA motor, pitch/rot clamps | OK | ~ | OK | - | - | live | high |
| `turret-plasma_dual.damage.gating_die_respawn` | Damage handling: friendly-fire scale, retaliate, die + timed respawn | ~ | ~ | ? | MISS | MISS | live | high |
...
| `turret-tesla.damage.lifecycle` | Damage gating, ammo regen, death blast + respawn | OK | ~ | ~ | - | - | live | high |
| `turret-tesla.spawn.liveness` | Map spawnfunc wiring + per-frame think (turret_tesla placed on map) | OK | OK | OK | - | - | live | high |
| `turret-tesla.firecheck.custom` | Custom firecheck: rescan + cooldown + ammo + target gate | OK | ~ | ~ | - | - | live | high |
| `turret-tesla.weapon.chain` | Chain-lightning discharge (toast loop): nearest-LOS first hop, 10-hop decay | OK | ~ | OK | - | - | live | high |
| `turret-tesla.weapon.arc_fx` | Per-hop lightning arc visual + discharge sound | OK | OK | OK | OK | ~ | live | high |
| `turret-tesla.anim.tr_think` | tr_think head spin-up + idle random crackle arc | MISS | MISS | MISS | MISS | - | - | high |
...
| `turret-walker.combat.brain` | Acquire/aim/fire combat brain (shared turret_think framework) | OK | ~ | OK | - | - | live | medium |
| `turret-walker.drive.chase` | tr_think locomotion: chase enemy (run/walk) + body yaw | OK | OK | ~ | - | - | live | high |
| `turret-walker.drive.idle_roam` | Idle roam/wander + last-seen pursuit + waypoint path following | MISS | MISS | MISS | - | - | - | high |
| `turret-walker.drive.gaits_extra` | Extra gaits: swim / jump / land / pain / strafe / turn | MISS | MISS | MISS | MISS | - | - | high |
| `turret-walker.weapon.minigun` | WalkerTurretAttack: near-hitscan minigun (fireBullet + force) | OK | ~ | OK | MISS | OK | live | high |
| `turret-walker.weapon.rocket` | Rocket volley: 4 homing rockets + reload (walker_fire_rocket / walker_rocket_think) | ~ | OK | OK | MISS | ~ | live | high |
| `turret-walker.weapon.melee` | Melee bite (walker_melee_do_dmg): radius hit in front | OK | OK | OK | - | - | live | high |
| `turret-walker.head.track` | Head rotation: track type + aim clamps | ~ | ~ | OK | - | - | live | high |
...
| `vehicle-bumblebee.spawn.swim_liquidmask` | swim flag -> dphitcontentsmask liquid behavior | MISS | OK | - | - | - | - | high |
| `vehicle-bumblebee.setup.vr_setup` | vr_setup: capability-flag derivation + respawntime | ~ | OK | - | - | - | live | high |
| `vehicle-bumblebee.pilot.flight` | Pilot flight controller (avelocity yaw/pitch, thrust, roll, climb) | OK | OK | OK | - | - | DEAD | high |
| `vehicle-bumblebee.pilot.raygun` | Center raygun: heal-beam (default) + damage-beam, target lock, energy gate | ~ | OK | OK | MISS | - | DEAD | high |
| `vehicle-bumblebee.gunner.frame` | Side-gunner turret: per-gun lock + lead + aim + plasma fire | OK | OK | OK | MISS | - | DEAD | high |
| `vehicle-bumblebee.gunner.cannon` | Side-gunner plasma cannon projectile (bumblebee_fire_cannon) | OK | OK | - | MISS | OK | DEAD | high |
| `vehicle-bumblebee.regen` | Regen: per-gun cannon ammo + body shield/energy/health | OK | OK | OK | - | - | DEAD | high |
| `vehicle-bumblebee.multiseat.enter` | Multi-seat boarding: gunner-slot assignment + role ordering | OK | OK | OK | - | - | DEAD | high |
| `vehicle-bumblebee.multiseat.exit` | Multi-seat exit: gunner eject + pilot exit + auto-land | OK | OK | OK | - | - | DEAD | high |
| `vehicle-bumblebee.board.usekey` | +use board/exit dispatch (PlayerUseKey) | OK | OK | - | - | - | DEAD | high |
| `vehicle-bumblebee.death` | Death: eject, gib toss, blowup, respawn | ~ | OK | OK | MISS | MISS | DEAD | high |
| `vehicle-bumblebee.impact.bouncepain` | vr_impact bounce pain (vehicles_impact) | MISS | MISS | - | - | - | - | high |
| `vehicle-bumblebee.client.presentation` | Client presentation: BRG beam, HUD, crosshairs, models, describe | MISS | MISS | MISS | MISS | - | DEAD | high |
...
| `vehicle-framework.think.tick` | vehicles_think — per-tick think cadence + painframe + W2MODE mirror | ~ | OK | OK | MISS | - | live | high |
...
| `vehicle-framework.combat.damage` | vehicles_damage — per-weapon rate, shield-then-health, death eject | OK | OK | OK | ~ | ~ | DEAD | high |
| `vehicle-framework.combat.heal` | vehicles_heal — health restore with limit + owner percentage mirror | MISS | MISS | - | - | - | - | high |
...
| `vehicle-framework.combat.crush` | vehicles_touch crush + vehicles_crushable — run over players/monsters | MISS | MISS | - | - | - | - | high |
| `vehicle-framework.combat.impact` | vehicles_impact — fall/collision self-damage | MISS | MISS | MISS | - | - | - | high |
| `vehicle-framework.combat.painframe` | vehicles_painframe — low-health smoke + DMGSHAKE/DMGROLL jitter | MISS | MISS | MISS | MISS | - | - | high |
...
| `vehicle-framework.presentation.hud_camera_xhair` | Vehicles_drawHUD / drawCrosshair / AuxiliaryXhair / CSQCVehicleSetup + cockpit camera | stub | OK | - | stub | MISS | DEAD | high |
| `vehicle-framework.hooks.init_touch` | MUTATOR_CALLHOOK(VehicleInit / VehicleTouch) dispatch | stub | - | - | - | - | DEAD | high |
...
| `vehicle-racer.spawnfunc.liveness` | Map spawnfunc wiring + master cvar gate (vehicle_racer on map) | OK | OK | OK | - | - | live | high |
...
| `vehicle-racer.impact.bouncepain` | vr_impact: ram/collision fall-damage (vehicles_impact bouncepain) | MISS | MISS | MISS | - | - | - | high |

### `vehicle-raptor` (vehicle) — 13 features

| id | name | L | V | T | P | A | live | conf |
|---|---|---|---|---|---|---|---|---|
| `raptor.spawn.setup` | Spawn / setup (hitbox, resources, capability flags, sub-entities) | ~ | OK | OK | MISS | - | live | high |
...
| `raptor.bombs` | Secondary — cluster bombs burst into bomblets | ~ | ~ | ~ | MISS | - | live | high |
...
| `raptor.impact` | Bounce impact damage / occupant shake (vr_impact, bouncepain) | MISS | MISS | - | - | MISS | - | high |
...
| `vehicle-spiderbot.enter` | vr_enter — W2MODE=GUIDE, seat the pilot, reattach a carried CTF flag to the head | ~ | OK | - | - | - | live | high |
| `vehicle-spiderbot.exit` | spiderbot_exit — unguide in-flight rockets, eject pilot with momentum/ahead-spot | OK | OK | - | - | - | live | high |
| `vehicle-spiderbot.frame.controller` | spiderbot_frame per-frame controller (drive dispatch + game_stopped + pilot glue) | OK | OK | ~ | - | - | live | high |
| `vehicle-spiderbot.frame.head_aim` | Head turret aim toward the pilot crosshair (turn + pitch within limits) | OK | ~ | ~ | - | - | live | high |
| `vehicle-spiderbot.frame.groundalign` | 4-point leg ground alignment (movelib_groundalign4point) | OK | OK | OK | - | - | live | medium |
| `vehicle-spiderbot.frame.locomotion` | Walk/strafe/idle locomotion + body turn + gravity step | OK | OK | ~ | - | - | live | high |
| `vehicle-spiderbot.frame.jump` | Directional jump (launch from wishmove) + jump/land latch | OK | OK | OK | ~ | ~ | live | high |
...
| `vehicle-spiderbot.death.blowup` | vr_death + spiderbot_blowup (burn, gib entities, 250-dmg blast, respawn) | OK | OK | OK | ~ | ~ | live | high |
...
| `overkill-weapons.okhmg.primary_auto` | OK Heavy MachineGun primary — superweapon auto bullet | OK | OK | OK | ~ | ~ | live | high |
...
| `overkill-weapons.okshotgun.primary_pellets` | OK Shotgun primary — pellet fan | OK | OK | OK | ~ | ~ | live | high |
| `overkill-weapons.okrpc.primary_chainsaw_missile` | OK RPC primary — accelerating chainsaw missile (pass-through + explosion) | OK | OK | OK | ~ | ~ | live | medium |
...
| `overkill-weapons.presentation.fx` | Fire/impact presentation — muzzle flash, casings, recoil, impact effects | - | - | - | MISS | ~ | - | high |
...
| `weapon-arc.beam.heal_teammates` | Beam heals teammates (health + armor) instead of damaging | ~ | OK | OK | - | - | live | high |
| `weapon-arc.beam.falloff` | Exponential distance falloff on beam damage + force | OK | OK | - | - | - | live | high |
| `weapon-arc.beam.heat_overheat` | Barrel heat accumulation, overheat jam, and cooldown | ~ | OK | ~ | MISS | ~ | live | high |
...
| `weapon-arc.checkammo` | Ammo checks (wr_checkammo1/2) + out-of-ammo auto-switch | ~ | ~ | - | - | - | live | high |
...
| `weapon-blaster.bolt.touch_radiusdamage` | Bolt impact: radius damage + knockback with force_zscale (W_Blaster_Touch / RadiusDamageForSource) *(intended)* | OK | OK | - | ~ | OK | live | high |
...
| `weapon-blaster.offhand.fire` | Offhand blaster (g_offhand_blaster mutator) fires without switching weapons | OK | ~ | ~ | - | - | ~ | medium |
| `weapon-blaster.bot.aim_dodge` | Bot weapon aim (wr_aim) + bot_dodge of incoming bolts | MISS | MISS | - | - | - | - | high |
...
| `crylink.projectile.touch_bounce_fade` | Spike touch: faded radius damage, limited bounces, bounce-damage factor | ~ | OK | OK | OK | ~ | live | high |
| `crylink.linkjoin.converge_on_release` | Link-join: held group converges on release (W_Crylink_LinkJoin) | OK | OK | OK | - | - | live | high |
| `crylink.linkexplode.chain_detonate` | Link-explode: chain-detonate the group on a damaging hit (W_Crylink_LinkExplode) | ~ | OK | OK | ~ | ~ | live | high |
| `crylink.linkjoin.joinexplode_bonus` | Convergence join-explode bonus + EFFECT_CRYLINK_JOINEXPLODE (W_Crylink_LinkJoinEffect_Think) | MISS | MISS | MISS | MISS | - | DEAD | high |
| `crylink.ammo.checkammo` | Per-mode ammo check + wait-release ammo guard (wr_checkammo1/2) | ~ | OK | - | - | - | live | high |
| `crylink.reload` | Forced reload + clip system (wr_reload) | OK | OK | OK | - | OK | DEAD | medium |
...
### `weapon-devastator` (weapon) — 10 features
...
| `weapon-devastator.flight.acceleration` | Rocket acceleration from speedstart toward speed | OK | ~ | OK | - | - | live | high |
| `weapon-devastator.flight.laser_guide` | Laser guiding: steer rocket toward owner aim (guiderate-capped, goal-point lead) | OK | OK | OK | ~ | OK | live | high |
| `weapon-devastator.explode.contact` | Contact / lifetime explosion: radius damage + force_xyscale knockback | ~ | OK | OK | OK | OK | live | high |
| `weapon-devastator.explode.remote` | Secondary remote detonation (rl_detonate_later + spawnshield/proximity gate) | ~ | OK | OK | OK | OK | live | high |
| `weapon-devastator.rocket.shootdown` | Shootable rocket (event_damage destroys it -> explode) | ~ | ~ | - | - | - | DEAD | high |
| `weapon-devastator.firer.transparency` | Rocket transparent to firer (PROJECTILE_MAKETRIGGER SOLID_CORPSE) | OK | OK | - | - | - | live | high |
| `weapon-devastator.ammo.checkammo_reload` | Ammo check / reload / reset-on-death | ~ | OK | OK | - | - | ~ | medium |
...
| `electro.primary.bolt_projectile` | Primary bolt projectile (MOVETYPE_FLY, velocity, lifetime) | OK | OK | ~ | MISS | ~ | live | high |
| `electro.primary.explode_splash` | Bolt explosion splash damage | OK | OK | - | OK | MISS | live | high |
| `electro.combo.trigger_chain` | Combo: bolt blast triggers nearby orbs into a chained explosion | ~ | ~ | ~ | OK | MISS | live | high |
| `electro.primary.midaircombo` | Primary bolt midair-combo (trigger orbs in flight) | ~ | ~ | ~ | OK | MISS | DEAD | high |
| `electro.secondary.orb_stream` | Secondary orb stream (count orbs, one per animtime while held) | OK | OK | OK | - | - | live | high |
| `electro.secondary.orb_projectile` | Secondary orb projectile (MOVETYPE_BOUNCE, gravity, shootable HP) | OK | ~ | OK | MISS | MISS | live | high |
| `electro.secondary.orb_touch_explode` | Orb touch: explode on player vs bounce (+ bounce sound) | ~ | OK | - | OK | ~ | live | high |
| `electro.secondary.orb_shotdown_combo` | Shoot-down orb converts to a combo blast | ~ | OK | - | OK | MISS | DEAD | high |
| `electro.ammo_reload` | Ammo checks + reload (cells, combo_safeammocheck) | ~ | OK | - | - | - | live | high |
| `electro.deathmessages` | Kill / suicide obituary lines (bolt/orb/combo variants) | OK | OK | - | OK | - | live | medium |
| `electro.electrobitch_announce` | ELECTROBITCH airshot announcement (direct bolt kill on flying enemy) | MISS | - | - | MISS | MISS | - | high |
...
| `weapon-fireball.primary.chargeup` | Primary charge-up: 5-frame prefire windup (prefire sound + prefire-muzzleflash effects) | MISS | MISS | MISS | MISS | MISS | - | high |
...
| `weapon-fireball.primary.lifetime` | Fireball think: lifetime timeout explode + periodic laser scorch (0.1s) | ~ | OK | OK | - | - | live | high |
| `weapon-fireball.primary.explode` | Fireball explode: heavy radius damage on impact/timeout | OK | OK | - | ~ | OK | live | high |
| `weapon-fireball.primary.bfg` | BFG secondary blast: damage every visible enemy within bfgradius (distance-scaled, LOS-gated) | ~ | ~ | - | MISS | - | live | high |
| `weapon-fireball.primary.laserscorch` | Laser scorch: periodically set one nearby enemy alight (weighted nearest, prefer not-burning) | ~ | OK | OK | MISS | - | live | medium |
| `weapon-fireball.primary.shootable` | Shootable fireball (event_damage destroys it; default health 0) | ~ | OK | - | - | - | DEAD | medium |
| `weapon-fireball.secondary.firemine` | Secondary: lob gravity bouncing firemine (MOVETYPE_BOUNCE, ±4, up-launch) | ~ | OK | OK | ~ | OK | live | high |
| `weapon-fireball.secondary.firemine.lifecycle` | Firemine think/touch: scorch nearby, self-destruct at lifetime, ignite-on-touch-or-bounce | ~ | OK | OK | ~ | ~ | live | high |
| `weapon-fireball.burn.model` | Fire damage-over-time (Fire_AddDamage / Fire_ApplyDamage) backing both projectiles' burns | ~ | ~ | ~ | - | - | live | medium |
| `weapon-fireball.bot.obituary` | Bot aim (wr_aim) + kill/suicide obituary lines (FIREMINE vs BLAST) | MISS | MISS | - | MISS | - | - | medium |

### `weapon-hagar` (weapon) — 11 features

| id | name | L | V | T | P | A | live | conf |
|---|---|---|---|---|---|---|---|---|
| `hagar.primary.attack` | Primary rapid-fire straight rocket stream | OK | OK | OK | OK | OK | live | high |
| `hagar.secondary.bounce` | Non-loaded secondary: single bouncing rocket | OK | OK | OK | ~ | OK | DEAD | high |
| `hagar.secondary.load_release` | Loaded secondary salvo (release fan + per-shot bias spread) *(intended)* | ~ | OK | ~ | OK | OK | live | high |
| `hagar.secondary.load_charge_machine` | Hold-to-charge incremental load state machine *(intended)* | MISS | MISS | MISS | MISS | MISS | DEAD | high |
| `hagar.secondary.load_audio` | Load / beep / warning charge sounds | MISS | - | MISS | - | MISS | DEAD | high |
| `hagar.damage.shootdown` | Shootable rocket -> burst when shot (W_Hagar_Damage) | ~ | OK | OK | OK | OK | live | medium |
| `hagar.explosion.radiusdamage` | Explosion: radius damage + knockback | OK | OK | OK | OK | OK | live | high |
| `hagar.fx.muzzle_explode_trail` | Muzzle flash, explosion particle, rocket trail, impact sound *(intended)* | OK | OK | OK | OK | OK | live | high |
| `hagar.hud.load_ring` | Crosshair Hagar load ring | stub | OK | - | stub | - | DEAD | high |
| `hagar.identity` | Weapon identity, flags, models, pickup/switch balance | OK | OK | OK | OK | - | live | high |
| `hagar.notifications.killmessages` | Burst-vs-spray kill message + suicide message | MISS | - | - | MISS | - | DEAD | medium |

### `weapon-hlac` (weapon) — 9 features

| id | name | L | V | T | P | A | live | conf |
|---|---|---|---|---|---|---|---|---|
| `weapon-hlac.primary.attack` | Primary rapid-fire single bolt with held-fire spread accumulation | ~ | OK | OK | - | - | live | high |
...
| `weapon-hlac.recoil.punchangle` | Per-shot punchangle recoil kick | ~ | OK | - | ~ | - | live | high |
...
| `weapon-hook.primary.latch` | GrapplingHookTouch / GrapplingHook_Stop: latch onto what it hits | ~ | - | OK | MISS | OK | live | high |
| `weapon-hook.primary.reel_pull` | GrapplingHookThink: reel the firer toward the latch | ~ | ~ | OK | - | - | live | high |
...
| `weapon-hook.offhand.mutator` | Grappling Hook offhand mutator (g_grappling_hook) | OK | OK | OK | - | - | DEAD | high |
| `weapon-hook.mutator.vampirehook` | Vampire Hook (drain HP while hooked to an enemy) | ~ | OK | OK | - | - | DEAD | high |
...
| `machinegun.fire.auto` | Sustained automatic primary fire (spread accumulation + per-shot damage/ammo) | OK | ~ | OK | - | - | live | high |
| `machinegun.fire.burst` | Burst secondary (3-round no-spread burst, count-up scheduling, cooldown) | ~ | ~ | OK | - | - | live | high |
| `machinegun.fire.single_mode0` | Single 'first'/sustained shot (mode 0 primary + secondary snipe) | ~ | OK | OK | - | - | DEAD | medium |
| `machinegun.spread.accumulation` | Spread accumulation: time-decay (default) + legacy counter branch | OK | ~ | OK | - | - | live | high |
...
| `machinegun.recoil` | Firing recoil (punchangle random kick unless g_norecoil) | ~ | OK | - | OK | - | live | high |
| `machinegun.presentation.muzzle_impact` | Muzzle flash + bullet-impact particle effects + casing ejection | OK | OK | OK | ~ | - | ~ | high |
| `machinegun.audio.impact_ricochet` | Bullet-impact random ricochet sound (SND_RIC_RANDOM) | MISS | MISS | MISS | MISS | MISS | DEAD | high |
| `machinegun.bot.wr_aim` | Bot fire logic (wr_aim distance-based primary/secondary selection) | MISS | MISS | - | - | - | DEAD | high |
| `machinegun.notification.kill_suicide` | Kill/suicide obituary (MURDER_SNIPE vs MURDER_SPRAY, THINKING_WITH_PORTALS suicide) | ~ | OK | - | OK | - | ~ | high |

### `weapon-minelayer` (weapon) — 13 features

| id | name | L | V | T | P | A | live | conf |
|---|---|---|---|---|---|---|---|---|
| `minelayer.fire.lay_mine` | Primary fire: lay a tossed mine | OK | OK | OK | ~ | OK | ~ | high |
| `minelayer.fire.mine_limit` | Per-player mine limit gate | ~ | OK | OK | MISS | MISS | ~ | high |
| `minelayer.mine.stick` | Mine sticks to BSP surface and locks in place | ~ | OK | OK | ~ | OK | ~ | high |
| `minelayer.mine.proximity` | Proximity detonation (closer enemy = sooner) | ~ | OK | OK | - | OK | ~ | high |
| `minelayer.mine.lifetime_countdown` | Lifetime expiry + countdown warning | OK | OK | OK | - | OK | ~ | high |
| `minelayer.mine.owner_death` | Owner death/disconnect/frozen auto-detonate | ~ | - | OK | - | - | ~ | high |
| `minelayer.mine.shootdown` | Mine shoot-down: knock loose / destroy when shot | stub | OK | - | - | - | DEAD | high |
| `minelayer.fire.remote_detonate` | Secondary fire: remote-detonate all placed mines | ~ | OK | OK | - | OK | ~ | high |
| `minelayer.mine.explode` | Explosion: radius damage + knockback + fx | OK | OK | - | ~ | OK | ~ | high |
| `minelayer.mine.render` | Placed-mine model + networking (visible mine) | - | - | - | MISS | - | - | high |
...
| `mortar.primary.attack` | Primary: impact grenade launch (type 0) | OK | OK | OK | ~ | OK | live | high |
| `mortar.secondary.attack` | Secondary: bouncing grenade launch (type 1) | OK | OK | OK | ~ | OK | live | high |
| `mortar.grenade.bounce` | Grenade bounce physics + contact handling (Touch1/Touch2) | OK | OK | OK | ~ | OK | live | high |
| `mortar.grenade.lifetime_detonation` | Lifetime timeout + remote-detonate think (Think1) | OK | OK | OK | - | - | live | high |
| `mortar.grenade.shootdown` | Shootable grenade -> explode when destroyed (W_Mortar_Grenade_Damage) | ~ | OK | OK | - | - | DEAD | high |
| `mortar.explosion.radiusdamage` | Explosion: radius damage + knockback + remove | OK | OK | OK | OK | OK | live | high |
| `mortar.secondary.remote_detonate` | Secondary remote-detonate of own primaries (remote_detonateprimary) | ~ | ~ | OK | - | ~ | ~ | high |
| `mortar.fx.projectile_visual` | In-flight grenade model + trail (CSQCProjectile) | MISS | MISS | - | MISS | - | DEAD | medium |
| `mortar.fx.airshot` | Airshot achievement announcement | MISS | - | - | - | MISS | DEAD | high |
...
| `weapon-porto.touch.placement_tree` | On-touch portal placement decision tree (in/out/combined red->blue) | ~ | ~ | OK | - | ~ | live | high |
...
| `weapon-porto.lifecycle.lifetime_self_destruct` | Lifetime self-destruct + success cleanup (Think/Fail/Success) | ~ | OK | OK | - | ~ | live | medium |
...
| `weapon-porto.presentation.projectile_render` | Projectile render (PORTO_RED / PORTO_BLUE, trail, scale) | OK | OK | - | OK | - | ? | medium |
| `weapon-porto.fire.strength_boost` | Strength powerup launch-speed boost | ~ | ~ | - | - | - | DEAD | high |
...
| `rifle.think.gates` | wr_think gates — refire + burst-budget accumulator, primary/secondary routing | OK | OK | OK | - | - | live | high |
| `rifle.bullethail` | Held-fire bullethail continuation (W_Rifle_BulletHail/_Continue) | OK | OK | OK | - | - | live | high |
| `rifle.fire.bullet` | W_Rifle_FireBullet — fire `shots` piercing hitscan bullets (damage/spread/penetration/falloff/force/headshot) | OK | OK | - | - | - | live | high |
| `rifle.ammo.decrease` | W_DecreaseAmmo — clip-aware ammo consumption per shot | ~ | OK | - | - | - | live | high |
| `rifle.reload` | Reload system (wr_reload, forced reload, secondary `reload` flag, wr_checkammo clip term) | MISS | MISS | MISS | MISS | MISS | DEAD | high |
...
| `rifle.fx.tracer` | Bullet tracer trail (EFFECT_RIFLE primary / EFFECT_RIFLE_WEAK secondary) | MISS | stub | - | MISS | - | DEAD | high |
| `rifle.audio.fire` | Fire sound (SND_RIFLE_FIRE primary / SND_RIFLE_FIRE2 secondary) | OK | ~ | - | - | ~ | live | high |
| `rifle.audio.ric` | Bullet impact ricochet sound (SND_RIC_RANDOM) | MISS | MISS | - | - | MISS | - | high |
| `rifle.casings` | Brass casing ejection (g_casings >= 2) | MISS | MISS | - | MISS | MISS | - | high |
| `rifle.zoom_eye` | Zoom-from-eye shot re-aim (BUTTON_ZOOM/ZOOMSCRIPT) + wr_zoom/wr_zoomdir | ~ | - | - | ~ | - | ~ | medium |
| `rifle.bot_aim` | Bot aim — riflemooth primary/secondary toggle (wr_aim) | MISS | MISS | - | - | - | DEAD | medium |
| `rifle.resetplayer` | wr_resetplayer — burst accumulator reset on spawn | MISS | - | - | - | - | DEAD | high |
...
| `weapon-seeker.missile_homing` | Missile think: accel/decel speed clamp + turnrate homing | ~ | OK | OK | - | - | live | high |
| `weapon-seeker.missile_explode` | Missile explosion (radius damage + knockback) | OK | OK | OK | OK | ~ | live | high |
| `weapon-seeker.missile_shootdown` | Shootable missile (HP pool, self-damage x0.25, explode-on-death) | stub | ~ | - | - | - | DEAD | high |
| `weapon-seeker.flac_fire` | FLAC secondary spray (f_diff muzzle cycle, spread, short-lived explosive) | OK | OK | OK | ~ | ~ | live | high |
| `weapon-seeker.tag_fire` | Tag dart launch + on-touch tracker registration | ~ | OK | OK | ~ | OK | live | high |
| `weapon-seeker.tag_shootdown` | Shootable tag dart (HP pool, explode-on-death) | stub | ~ | - | - | - | DEAD | high |
| `weapon-seeker.volley_controller` | Tag volley controller (type 0): auto-fire missile_count missiles at the tagged target | ~ | ~ | ~ | - | - | live | medium |
...
| `weapon-shotgun.ammo.checkammo_reload` | Ammo checks + reload | OK | ~ | ? | - | - | live | medium |
...
| `weapon-shotgun.fx.impact_ricochet_audio` | Impact ricochet sound + melee woosh + casing eject | MISS | MISS | MISS | MISS | MISS | - | high |
| `weapon-shotgun.notify.killmessage` | Obituary: slap vs blast kill message + suicide line | ~ | OK | - | - | - | ~ | high |

### `weapon-tuba` (weapon) — 10 features

| id | name | L | V | T | P | A | live | conf |
|---|---|---|---|---|---|---|---|---|
| `weapon-tuba.fire.note_blast` | Held-fire note: refire-gated radius blast centered on player | ~ | OK | OK | - | - | live | high |
| `weapon-tuba.deathtype.instrument_bits` | Death-type carries instrument/secondary bits for obituary selection | ~ | MISS | - | MISS | - | live | high |
| `weapon-tuba.reload.instrument_cycle` | Reload cycles instrument Tuba -> Accordion -> Klein Bottle | stub | MISS | MISS | MISS | stub | DEAD | high |
...
| `weapon-tuba.fx.smoke_ring` | Per-note smoke ring puff | MISS | MISS | MISS | MISS | - | - | high |
| `weapon-tuba.audio.note_sound` | Sustained pitched note sound (loop sample, pitch step, fade, attenuation, networking) | MISS | MISS | MISS | MISS | stub | ~ | high |
| `weapon-tuba.melody.recognition` | Melody recognition + magic-ear chat (W_Tuba_HasPlayed / lastnotes) | MISS | MISS | MISS | MISS | - | - | high |
| `weapon-tuba.setup.instrument_reset` | wr_setup resets instrument to Tuba on (re)equip | MISS | MISS | - | - | - | - | high |
...
| `weapon-vaporizer.primary.fire_sound` | Primary fire sound (minstanexfire) | OK | ~ | OK | - | ~ | live | high |
| `weapon-vaporizer.primary.beam_particle` | Rail beam visual (CSQC cylindric beam) + muzzle flash | MISS | MISS | MISS | MISS | - | - | high |
| `weapon-vaporizer.primary.impact_effect` | Beam impact effect + sound (VORTEX_IMPACT / neximpact) | MISS | MISS | - | MISS | MISS | - | high |
...
| `weapon-vaporizer.secondary.blaster_laser` | Secondary Blaster knockback laser (plain instagib) | OK | ~ | ~ | - | - | ~ | medium |
| `weapon-vaporizer.rm.primary_explosion` | Rocket-Minsta: explosion at the rail endpoint | ~ | ~ | - | MISS | - | ? | high |
| `weapon-vaporizer.rm.laser_barrage` | Rocket-Minsta: secondary bouncing-laser fan + rapid-fire ladder | ~ | ~ | ~ | MISS | ~ | ? | high |
| `weapon-vaporizer.ammo.consumption` | Ammo consumption + checkammo + reload | ~ | ~ | - | - | - | ~ | medium |
...
| `weapon-vortex.attack.overcharge_sound` | Overcharge zap sound when charge > charge_animlimit | OK | OK | OK | - | ~ | live | high |
...
| `weapon-vortex.hud.charge_ring` | Charge ring (+ chargepool inner ring) on the crosshair | stub | OK | - | stub | - | DEAD | high |
...
| `weapon-vortex.achievements` | Yoda (mid-air rail kill) + Impressive (consecutive long-range hit) announcements | MISS | - | - | - | MISS | - | high |
