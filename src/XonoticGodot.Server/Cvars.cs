...
public static class Cvars
{
    ...
    public static readonly CvarDef[] Defaults =
    {
        ...
        // ---- health / armor regen + rot (balance: balance-health) ----
        new("g_balance_health_regen", "0", Notify),
        new("g_balance_health_regenlinear", "0", Notify),
        new("g_balance_health_regenstable", "100", Notify),
        new("g_balance_health_rot", "0.05", Notify),
        ...
        new("g_balance_armor_regenstable", "0", Notify),
        new("g_balance_armor_rot", "0", Notify),
        new("g_balance_armor_rotlinear", "0", Notify),
        new("g_balance_armor_rotstable", "0", Notify),
        ...
        new("g_balance_pause_health_regen", "5", Notify, "no regen for N s after damage"),
        new("g_balance_pause_health_rot", "1", Notify),
        new("g_balance_pause_armor_rot", "1", Notify),
        new("g_balance_pause_fuel_regen", "2", Notify),
        new("g_balance_pause_fuel_rot", "2", Notify),
        ...
        new("skill", "5", Save, "bot skill 0..10 (>100 = superbot)"),
        new("skill_auto", "0", Save),
        new("bot_god", "0", Save),
        new("bot_nofire", "0", Save),
        new("bot_ignore_bots", "0", Save),
        new("bot_typefrag", "1", Save),
        new("bot_wander_enable", "1", Save),

        // ---- bot AI tuning (bot cvars; defaults from xonotic-server.cfg) ----
        new("bot_ai_thinkinterval", "0.05", Save),
        new("bot_ai_strategyinterval", "5", Save),
        new("bot_ai_strategyinterval_movingtarget", "2", Save),
        new("bot_ai_enemydetectioninterval", "0.5", Save),
        new("bot_ai_enemydetectioninterval_stickingtoenemy", "0.2", Save),
        ...
        new("bot_ai_timeitems_minrespawndelay", "11", Save),
        new("bot_ai_weapon_combo", "1", Save),
        new("bot_ai_weapon_combo_threshold", "0.4", Save),
        new("bot_ai_aimskill_offset", "0.3", Save),
        new("bot_ai_aimskill_think", "1", Save),
        new("bot_ai_aimskill_mouse", "1", Save),
        new("bot_ai_aimskill_fixedrate", "0.25", Save),
        new("bot_ai_aimskill_blendrate", "2", Save),
        new("bot_ai_aimskill_firetolerance", "1", Save),
        new("bot_ai_bunnyhop_skilloffset", "6", Save, "skill at/above which bots bunnyhop"),
        new("bot_ai_bunnyhop_dir_deviation_max", "10", Save),
        new("bot_ai_bunnyhop_downward_pitch_max", "30", Save),
        new("bot_ai_bunnyhop_turn_angle_min", "0", Save),
        new("bot_ai_bunnyhop_turn_angle_max", "60", Save),
        new("bot_ai_bunnyhop_turn_angle_reduction", "10", Save),
        new("bot_ai_custom_weapon_priority_distances", "300 1000", Save),
    ...
    public static float Skill => FloatOr("skill", 5f);
}
