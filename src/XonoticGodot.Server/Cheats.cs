...
/// at <c>sv_cheats &gt;= 2</c> non-players (observers) may cheat too. The trace/particle/file-I/O cheats
...
public sealed class Cheats
{
    ...
    /// </summary>
    public bool Allowed(Player p, bool ignoreDead = false)
    {
        ...
        return GameStartCheats != 0 && Cvars.Int("sv_cheats") != 0;
    }
