...
public partial class PortalRenderer : Node3D
{
    ...
    /// <summary><c>cl_portal_render</c> — default ON (an unset/empty cvar enables it); explicit <c>0</c> falls
    /// back to the dark-mirror placeholder. Read defensively so no registration is required.</summary>
